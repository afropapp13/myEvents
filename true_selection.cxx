...
void true_selection::Loop() {
	...
	TString TxtName = "/exp/uboone/data/users/"+UserID+"/myEvents/my3DTxtFiles/"+UBCodeVersion+"/TxtmyTrueEvents_"+fWhichSample+"_"+UBCodeVersion+".txt";
	ofstream myTxtFile;
	myTxtFile.open(TxtName);

	// Txt file to keep track of the run/subrun/event of the candidate events

	TString RunTxtName = "/exp/uboone/data/users/"+UserID+"/myEvents/my3DTxtFiles/"+UBCodeVersion+"/TxtmyTrueRunSubRunEvents_"+fWhichSample+"_"+UBCodeVersion+".txt";
