...
void mcc9_10_print_1d() {
	...
	plot_names.push_back("Reco_pd_vs_wc_vertexPlot");
	plot_names.push_back("CC1pReco_pd_vs_wc_vertexPlot");
	plot_names.push_back("NonCC1pReco_pd_vs_wc_vertexPlot");		
	...
	TString run = "Run4b_unified";
	TString file_path = PathToFiles + "/"+cut+"/STVStudies_mcc9_10_Overlay9_"+run+cut+".root";
