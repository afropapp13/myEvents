...
//		TH1D* RecodProtonTracksScorePlot = new TH1D("RecodProtonTracksScorePlot",RecoLabelXAxisProtonTrackScore,NBinsTrackScore,MinTrackScore,MaxTrackScore);	
		...
		TH1D* RecoDeltaAlpha3DMuPlot = new TH1D("RecoDeltaAlpha3DMuPlot",LabelXAxisDeltaAlpha3DMu,NBinsDeltaAlpha3DMu,ArrayNBinsDeltaAlpha3DMu);			
		...
		TH1D* CC1pTrueDeltaAlpha3DMuPlot = new TH1D("CC1pTrueDeltaAlpha3DMuPlot",LabelXAxisDeltaAlpha3DMu,NBinsDeltaAlpha3DMu,ArrayNBinsDeltaAlpha3DMu);				
...
//		TH1D* CC1pRecodProtonTracksScorePlot = new TH1D("CC1pRecodProtonTracksScorePlot",RecoLabelXAxisProtonTrackScore,NBinsTrackScore,MinTrackScore,MaxTrackScore);
		...
		TH1D* CC1pRecoDeltaAlpha3DMuPlot = new TH1D("CC1pRecoDeltaAlpha3DMuPlot",LabelXAxisDeltaAlpha3DMu,NBinsDeltaAlpha3DMu,ArrayNBinsDeltaAlpha3DMu);				
		...
		TH2D* CC1pRecoVertexXPlot2D = new TH2D("CC1pRecoVertexXPlot2D",RecoLabelXAxisVertexX2D,NBinsVertexX,MinVertexX,MaxVertexX,NBinsVertexX,MinVertexX,MaxVertexX);
		TH2D* CC1pRecoVertexYPlot2D = new TH2D("CC1pRecoVertexYPlot2D",RecoLabelXAxisVertexY2D,NBinsVertexY,MinVertexY,MaxVertexY,NBinsVertexY,MinVertexY,MaxVertexY);
		TH2D* CC1pRecoVertexZPlot2D = new TH2D("CC1pRecoVertexZPlot2D",RecoLabelXAxisVertexZ2D,NBinsVertexZ,MinVertexZ,MaxVertexZ,NBinsVertexZ,MinVertexZ,MaxVertexZ);			
		...
		TH2D* CC1pRecoDeltaAlpha3DMuPlot2D = new TH2D("CC1pRecoDeltaAlpha3DMuPlot2D",LabelXAxisDeltaAlpha3DMu2D,NBinsDeltaAlpha3DMu,
			ArrayNBinsDeltaAlpha3DMu,NBinsDeltaAlpha3DMu,ArrayNBinsDeltaAlpha3DMu);						
		...
		TH2D* POTScaledCC1pRecoVertexXPlot2D = new TH2D("POTScaledCC1pRecoVertexXPlot2D",RecoLabelXAxisVertexX2D,NBinsVertexX,MinVertexX,MaxVertexX,NBinsVertexX,MinVertexX,MaxVertexX);
		TH2D* POTScaledCC1pRecoVertexYPlot2D = new TH2D("POTScaledCC1pRecoVertexYPlot2D",RecoLabelXAxisVertexY2D,NBinsVertexY,MinVertexY,MaxVertexY,NBinsVertexY,MinVertexY,MaxVertexY);
		TH2D* POTScaledCC1pRecoVertexZPlot2D = new TH2D("POTScaledCC1pRecoVertexZPlot2D",RecoLabelXAxisVertexZ2D,NBinsVertexZ,MinVertexZ,MaxVertexZ,NBinsVertexZ,MinVertexZ,MaxVertexZ);
		...
		TH2D* POTScaledCC1pRecoDeltaAlpha3DqPlot2D = new TH2D("POTScaledCC1pRecoDeltaAlpha3DqPlot2D",LabelXAxisDeltaAlpha3Dq2D,NBinsDeltaAlpha3Dq,
			ArrayNBinsDeltaAlpha3Dq,NBinsDeltaAlpha3Dq,ArrayNBinsDeltaAlpha3Dq);
		TH2D* POTScaledCC1pRecoDeltaAlpha3DMuPlot2D = new TH2D("POTScaledCC1pRecoDeltaAlpha3DMuPlot2D",LabelXAxisDeltaAlpha3DMu2D,NBinsDeltaAlpha3DMu,
			ArrayNBinsDeltaAlpha3DMu,NBinsDeltaAlpha3DMu,ArrayNBinsDeltaAlpha3DMu);						
...
//		TH1D* NonCC1pRecodProtonTracksScorePlot = new TH1D("NonCC1pRecodProtonTracksScorePlot",RecoLabelXAxisProtonTrackScore,NBinsTrackScore,MinTrackScore,MaxTrackScore);
		...
		TH1D* NonCC1pRecoDeltaAlpha3DMuPlot = new TH1D("NonCC1pRecoDeltaAlpha3DMuPlot",LabelXAxisDeltaAlpha3DMu,NBinsDeltaAlpha3DMu,ArrayNBinsDeltaAlpha3DMu);		
...
//		TH1D* CCQERecodProtonTracksScorePlot = new TH1D("CCQERecodProtonTracksScorePlot",RecoLabelXAxisProtonTrackScore,NBinsTrackScore,MinTrackScore,MaxTrackScore);	
		...
		TH1D* CCQERecoDeltaAlpha3DMuPlot = new TH1D("CCQERecoDeltaAlpha3DMuPlot",LabelXAxisDeltaAlpha3DMu,NBinsDeltaAlpha3DMu,ArrayNBinsDeltaAlpha3DMu);				
...
//		TH1D* CCMECRecodProtonTracksScorePlot = new TH1D("CCMECRecodProtonTracksScorePlot",RecoLabelXAxisProtonTrackScore,NBinsTrackScore,MinTrackScore,MaxTrackScore);	
		...
		TH1D* CCMECRecoDeltaAlpha3DMuPlot = new TH1D("CCMECRecoDeltaAlpha3DMuPlot",LabelXAxisDeltaAlpha3DMu,NBinsDeltaAlpha3DMu,ArrayNBinsDeltaAlpha3DMu);				
...
//		TH1D* CCRESRecodProtonTracksScorePlot = new TH1D("CCRESRecodProtonTracksScorePlot",RecoLabelXAxisProtonTrackScore,NBinsTrackScore,MinTrackScore,MaxTrackScore);	
		...
		TH1D* CCRESRecoDeltaAlpha3DMuPlot = new TH1D("CCRESRecoDeltaAlpha3DMuPlot",LabelXAxisDeltaAlpha3DMu,NBinsDeltaAlpha3DMu,ArrayNBinsDeltaAlpha3DMu);				
...
//		TH1D* CCDISRecodProtonTracksScorePlot = new TH1D("CCDISRecodProtonTracksScorePlot",RecoLabelXAxisProtonTrackScore,NBinsTrackScore,MinTrackScore,MaxTrackScore);	
		...
		TH1D* CCDISRecoDeltaAlpha3DMuPlot = new TH1D("CCDISRecoDeltaAlpha3DMuPlot",LabelXAxisDeltaAlpha3DMu,NBinsDeltaAlpha3DMu,ArrayNBinsDeltaAlpha3DMu);				
...
//		TH1D* CosmicRecoChi2Plot = new TH1D("CosmicRecoChi2Plot",RecoLabelXAxisChi2,NBinsChi2,MinChi2,MaxChi2);
		...
		TH1D* RecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];
		TH1D* CC1pRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];
		TH1D* CC1pTrueDeltaAlpha3Dq_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];				
		TH1D* NonCC1pRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];		
		TH1D* CCQERecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];
		TH1D* CCMECRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];
		TH1D* CCRESRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];
		TH1D* CCDISRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];
		TH2D* CC1pRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot2D[TwoDNBinsDeltaPn];	
		TH2D* POTScaledCC1pRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot2D[TwoDNBinsDeltaPn];

		//----------------------------------------//		

		TH1D* RecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];
		TH1D* CC1pRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];
		TH1D* CC1pTrueDeltaAlpha3DMu_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];				
		TH1D* NonCC1pRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];		
		TH1D* CCQERecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];
		TH1D* CCMECRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];
		TH1D* CCRESRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];
		TH1D* CCDISRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[TwoDNBinsDeltaPn];
		TH2D* CC1pRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot2D[TwoDNBinsDeltaPn];	
		TH2D* POTScaledCC1pRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot2D[TwoDNBinsDeltaPn];			
		...
		for (int WhichDeltaPn = 0; WhichDeltaPn < TwoDNBinsDeltaPn; WhichDeltaPn++) {
			...
			// DeltaAlpha3Dq in DeltaPn slices
			...
			RecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("Reco"+DeltaAlpha3DqTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3Dq,TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn][0]);
			CC1pRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("CC1pReco"+DeltaAlpha3DqTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3Dq,TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn][0]);
			CC1pTrueDeltaAlpha3Dq_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("CC1pTrue"+DeltaAlpha3DqTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3Dq,TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn][0]);					
			NonCC1pRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("NonCC1pReco"+DeltaAlpha3DqTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3Dq,TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn][0]);
			CCQERecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("CCQEReco"+DeltaAlpha3DqTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3Dq,TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn][0]);
			CCMECRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("CCMECReco"+DeltaAlpha3DqTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3Dq,TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn][0]);
			CCRESRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("CCRESReco"+DeltaAlpha3DqTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3Dq,TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn][0]);
			CCDISRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("CCDISReco"+DeltaAlpha3DqTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3Dq,TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn][0]);	
			CC1pRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot2D[WhichDeltaPn] = new TH2D("CC1pReco"+DeltaAlpha3DqTwoDInDeltaPnLabel+"2D",LabelXAxisDeltaAlpha3Dq2D,TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn][0],TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn][0]);	
			POTScaledCC1pRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot2D[WhichDeltaPn] = new TH2D("POTScaledCC1pReco"+DeltaAlpha3DqTwoDInDeltaPnLabel+"2D",LabelXAxisDeltaAlpha3Dq2D,TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn][0],TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices[WhichDeltaPn][0]);																									

			//------------------------------//

			// DeltaAlpha3DMu in DeltaPn slices
			...
			RecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("Reco"+DeltaAlpha3DMuTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3DMu,TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn][0]);
			CC1pRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("CC1pReco"+DeltaAlpha3DMuTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3DMu,TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn][0]);
			CC1pTrueDeltaAlpha3DMu_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("CC1pTrue"+DeltaAlpha3DMuTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3DMu,TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn][0]);					
			NonCC1pRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("NonCC1pReco"+DeltaAlpha3DMuTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3DMu,TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn][0]);
			CCQERecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("CCQEReco"+DeltaAlpha3DMuTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3DMu,TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn][0]);
			CCMECRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("CCMECReco"+DeltaAlpha3DMuTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3DMu,TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn][0]);
			CCRESRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("CCRESReco"+DeltaAlpha3DMuTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3DMu,TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn][0]);
			CCDISRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[WhichDeltaPn] = new TH1D("CCDISReco"+DeltaAlpha3DMuTwoDInDeltaPnLabel,LabelXAxisDeltaAlpha3DMu,TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn][0]);	
			CC1pRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot2D[WhichDeltaPn] = new TH2D("CC1pReco"+DeltaAlpha3DMuTwoDInDeltaPnLabel+"2D",LabelXAxisDeltaAlpha3DMu2D,TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn][0],TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn][0]);	
			POTScaledCC1pRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot2D[WhichDeltaPn] = new TH2D("POTScaledCC1pReco"+DeltaAlpha3DMuTwoDInDeltaPnLabel+"2D",LabelXAxisDeltaAlpha3DMu2D,TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn][0],TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn].size()-1,&TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices[WhichDeltaPn][0]);																									
		...
		// DeltaAlphaT in muon momentum slices

		TH1D* RecoDeltaAlphaT_InMuonMomentumTwoDPlot[TwoDNBinsMuonMomentum];
		TH1D* CC1pRecoDeltaAlphaT_InMuonMomentumTwoDPlot[TwoDNBinsMuonMomentum];
		TH1D* CC1pTrueDeltaAlphaT_InMuonMomentumTwoDPlot[TwoDNBinsMuonMomentum];				
		TH1D* NonCC1pRecoDeltaAlphaT_InMuonMomentumTwoDPlot[TwoDNBinsMuonMomentum];		
		TH1D* CCQERecoDeltaAlphaT_InMuonMomentumTwoDPlot[TwoDNBinsMuonMomentum];
		TH1D* CCMECRecoDeltaAlphaT_InMuonMomentumTwoDPlot[TwoDNBinsMuonMomentum];
		TH1D* CCRESRecoDeltaAlphaT_InMuonMomentumTwoDPlot[TwoDNBinsMuonMomentum];
		TH1D* CCDISRecoDeltaAlphaT_InMuonMomentumTwoDPlot[TwoDNBinsMuonMomentum];
		TH2D* CC1pRecoDeltaAlphaT_InMuonMomentumTwoDPlot2D[TwoDNBinsMuonMomentum];	
		TH2D* POTScaledCC1pRecoDeltaAlphaT_InMuonMomentumTwoDPlot2D[TwoDNBinsMuonMomentum];
		...
		for (int WhichMuonMomentum = 0; WhichMuonMomentum < TwoDNBinsMuonMomentum; WhichMuonMomentum++) {
			...
			RecoDeltaAlphaT_InMuonMomentumTwoDPlot[WhichMuonMomentum] = new TH1D("Reco"+DeltaAlphaTTwoDInMuonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum][0]);
			CC1pRecoDeltaAlphaT_InMuonMomentumTwoDPlot[WhichMuonMomentum] = new TH1D("CC1pReco"+DeltaAlphaTTwoDInMuonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum][0]);
			CC1pTrueDeltaAlphaT_InMuonMomentumTwoDPlot[WhichMuonMomentum] = new TH1D("CC1pTrue"+DeltaAlphaTTwoDInMuonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum][0]);					
			NonCC1pRecoDeltaAlphaT_InMuonMomentumTwoDPlot[WhichMuonMomentum] = new TH1D("NonCC1pReco"+DeltaAlphaTTwoDInMuonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum][0]);
			CCQERecoDeltaAlphaT_InMuonMomentumTwoDPlot[WhichMuonMomentum] = new TH1D("CCQEReco"+DeltaAlphaTTwoDInMuonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum][0]);
			CCMECRecoDeltaAlphaT_InMuonMomentumTwoDPlot[WhichMuonMomentum] = new TH1D("CCMECReco"+DeltaAlphaTTwoDInMuonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum][0]);
			CCRESRecoDeltaAlphaT_InMuonMomentumTwoDPlot[WhichMuonMomentum] = new TH1D("CCRESReco"+DeltaAlphaTTwoDInMuonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum][0]);
			CCDISRecoDeltaAlphaT_InMuonMomentumTwoDPlot[WhichMuonMomentum] = new TH1D("CCDISReco"+DeltaAlphaTTwoDInMuonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum][0]);	
			CC1pRecoDeltaAlphaT_InMuonMomentumTwoDPlot2D[WhichMuonMomentum] = new TH2D("CC1pReco"+DeltaAlphaTTwoDInMuonMomentumLabel+"2D",LabelXAxisDeltaAlphaT2D,TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum][0],TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum][0]);	
			POTScaledCC1pRecoDeltaAlphaT_InMuonMomentumTwoDPlot2D[WhichMuonMomentum] = new TH2D("POTScaledCC1pReco"+DeltaAlphaTTwoDInMuonMomentumLabel+"2D",LabelXAxisDeltaAlphaT2D,TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum][0],TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices[WhichMuonMomentum][0]);
		...
		// DeltaAlphaT in proton momentum slices

		TH1D* RecoDeltaAlphaT_InProtonMomentumTwoDPlot[TwoDNBinsProtonMomentum];
		TH1D* CC1pRecoDeltaAlphaT_InProtonMomentumTwoDPlot[TwoDNBinsProtonMomentum];
		TH1D* CC1pTrueDeltaAlphaT_InProtonMomentumTwoDPlot[TwoDNBinsProtonMomentum];				
		TH1D* NonCC1pRecoDeltaAlphaT_InProtonMomentumTwoDPlot[TwoDNBinsProtonMomentum];		
		TH1D* CCQERecoDeltaAlphaT_InProtonMomentumTwoDPlot[TwoDNBinsProtonMomentum];
		TH1D* CCMECRecoDeltaAlphaT_InProtonMomentumTwoDPlot[TwoDNBinsProtonMomentum];
		TH1D* CCRESRecoDeltaAlphaT_InProtonMomentumTwoDPlot[TwoDNBinsProtonMomentum];
		TH1D* CCDISRecoDeltaAlphaT_InProtonMomentumTwoDPlot[TwoDNBinsProtonMomentum];
		TH2D* CC1pRecoDeltaAlphaT_InProtonMomentumTwoDPlot2D[TwoDNBinsProtonMomentum];	
		TH2D* POTScaledCC1pRecoDeltaAlphaT_InProtonMomentumTwoDPlot2D[TwoDNBinsProtonMomentum];	
		...
		for (int WhichProtonMomentum = 0; WhichProtonMomentum < TwoDNBinsProtonMomentum; WhichProtonMomentum++) {	
			...
			RecoDeltaAlphaT_InProtonMomentumTwoDPlot[WhichProtonMomentum] = new TH1D("Reco"+DeltaAlphaTTwoDInProtonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum][0]);
			CC1pRecoDeltaAlphaT_InProtonMomentumTwoDPlot[WhichProtonMomentum] = new TH1D("CC1pReco"+DeltaAlphaTTwoDInProtonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum][0]);
			CC1pTrueDeltaAlphaT_InProtonMomentumTwoDPlot[WhichProtonMomentum] = new TH1D("CC1pTrue"+DeltaAlphaTTwoDInProtonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum][0]);					
			NonCC1pRecoDeltaAlphaT_InProtonMomentumTwoDPlot[WhichProtonMomentum] = new TH1D("NonCC1pReco"+DeltaAlphaTTwoDInProtonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum][0]);
			CCQERecoDeltaAlphaT_InProtonMomentumTwoDPlot[WhichProtonMomentum] = new TH1D("CCQEReco"+DeltaAlphaTTwoDInProtonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum][0]);
			CCMECRecoDeltaAlphaT_InProtonMomentumTwoDPlot[WhichProtonMomentum] = new TH1D("CCMECReco"+DeltaAlphaTTwoDInProtonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum][0]);
			CCRESRecoDeltaAlphaT_InProtonMomentumTwoDPlot[WhichProtonMomentum] = new TH1D("CCRESReco"+DeltaAlphaTTwoDInProtonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum][0]);
			CCDISRecoDeltaAlphaT_InProtonMomentumTwoDPlot[WhichProtonMomentum] = new TH1D("CCDISReco"+DeltaAlphaTTwoDInProtonMomentumLabel,LabelXAxisDeltaAlphaT,TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum][0]);	
			CC1pRecoDeltaAlphaT_InProtonMomentumTwoDPlot2D[WhichProtonMomentum] = new TH2D("CC1pReco"+DeltaAlphaTTwoDInProtonMomentumLabel+"2D",LabelXAxisDeltaAlphaT2D,TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum][0],TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum][0]);	
			POTScaledCC1pRecoDeltaAlphaT_InProtonMomentumTwoDPlot2D[WhichProtonMomentum] = new TH2D("POTScaledCC1pReco"+DeltaAlphaTTwoDInProtonMomentumLabel+"2D",LabelXAxisDeltaAlphaT2D,TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum][0],TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum].size()-1,&TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices[WhichProtonMomentum][0]);
		...
		// ECal in DeltaPtx slices

		TH1D* RecoECal_InDeltaPtxTwoDPlot[TwoDNBinsDeltaPtx];
		TH1D* CC1pRecoECal_InDeltaPtxTwoDPlot[TwoDNBinsDeltaPtx];
		TH1D* CC1pTrueECal_InDeltaPtxTwoDPlot[TwoDNBinsDeltaPtx];				
		TH1D* NonCC1pRecoECal_InDeltaPtxTwoDPlot[TwoDNBinsDeltaPtx];		
		TH1D* CCQERecoECal_InDeltaPtxTwoDPlot[TwoDNBinsDeltaPtx];
		TH1D* CCMECRecoECal_InDeltaPtxTwoDPlot[TwoDNBinsDeltaPtx];
		TH1D* CCRESRecoECal_InDeltaPtxTwoDPlot[TwoDNBinsDeltaPtx];
		TH1D* CCDISRecoECal_InDeltaPtxTwoDPlot[TwoDNBinsDeltaPtx];
		TH2D* CC1pRecoECal_InDeltaPtxTwoDPlot2D[TwoDNBinsDeltaPtx];	
		TH2D* POTScaledCC1pRecoECal_InDeltaPtxTwoDPlot2D[TwoDNBinsDeltaPtx];					
		...
		for (int WhichDeltaPtx = 0; WhichDeltaPtx < TwoDNBinsDeltaPtx; WhichDeltaPtx++) {	
			...
			RecoECal_InDeltaPtxTwoDPlot[WhichDeltaPtx] = new TH1D("Reco"+ECalTwoDInDeltaPtxLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx].size()-1,&TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx][0]);
			CC1pRecoECal_InDeltaPtxTwoDPlot[WhichDeltaPtx] = new TH1D("CC1pReco"+ECalTwoDInDeltaPtxLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx].size()-1,&TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx][0]);
			CC1pTrueECal_InDeltaPtxTwoDPlot[WhichDeltaPtx] = new TH1D("CC1pTrue"+ECalTwoDInDeltaPtxLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx].size()-1,&TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx][0]);					
			NonCC1pRecoECal_InDeltaPtxTwoDPlot[WhichDeltaPtx] = new TH1D("NonCC1pReco"+ECalTwoDInDeltaPtxLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx].size()-1,&TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx][0]);
			CCQERecoECal_InDeltaPtxTwoDPlot[WhichDeltaPtx] = new TH1D("CCQEReco"+ECalTwoDInDeltaPtxLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx].size()-1,&TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx][0]);
			CCMECRecoECal_InDeltaPtxTwoDPlot[WhichDeltaPtx] = new TH1D("CCMECReco"+ECalTwoDInDeltaPtxLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx].size()-1,&TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx][0]);
			CCRESRecoECal_InDeltaPtxTwoDPlot[WhichDeltaPtx] = new TH1D("CCRESReco"+ECalTwoDInDeltaPtxLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx].size()-1,&TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx][0]);
			CCDISRecoECal_InDeltaPtxTwoDPlot[WhichDeltaPtx] = new TH1D("CCDISReco"+ECalTwoDInDeltaPtxLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx].size()-1,&TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx][0]);	
			CC1pRecoECal_InDeltaPtxTwoDPlot2D[WhichDeltaPtx] = new TH2D("CC1pReco"+ECalTwoDInDeltaPtxLabel+"2D",LabelXAxisECal2D,TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx].size()-1,&TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx][0],TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx].size()-1,&TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx][0]);	
			POTScaledCC1pRecoECal_InDeltaPtxTwoDPlot2D[WhichDeltaPtx] = new TH2D("POTScaledCC1pReco"+ECalTwoDInDeltaPtxLabel+"2D",LabelXAxisECal2D,TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx].size()-1,&TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx][0],TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx].size()-1,&TwoDArrayNBinsECalInDeltaPtxSlices[WhichDeltaPtx][0]);																									
			...
			for (int WhichDeltaPty = 0; WhichDeltaPty < TwoDNBinsDeltaPty; WhichDeltaPty++) {	
				...
				RecoECal_InDeltaPtxDeltaPtyTwoDPlot[WhichDeltaPtx][WhichDeltaPty] = new TH1D("Reco"+ECalTwoDInDeltaPtxDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty][0]);
				CC1pRecoECal_InDeltaPtxDeltaPtyTwoDPlot[WhichDeltaPtx][WhichDeltaPty] = new TH1D("CC1pReco"+ECalTwoDInDeltaPtxDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty][0]);
				CC1pTrueECal_InDeltaPtxDeltaPtyTwoDPlot[WhichDeltaPtx][WhichDeltaPty] = new TH1D("CC1pTrue"+ECalTwoDInDeltaPtxDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty][0]);					
				NonCC1pRecoECal_InDeltaPtxDeltaPtyTwoDPlot[WhichDeltaPtx][WhichDeltaPty] = new TH1D("NonCC1pReco"+ECalTwoDInDeltaPtxDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty][0]);
				CCQERecoECal_InDeltaPtxDeltaPtyTwoDPlot[WhichDeltaPtx][WhichDeltaPty] = new TH1D("CCQEReco"+ECalTwoDInDeltaPtxDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty][0]);
				CCMECRecoECal_InDeltaPtxDeltaPtyTwoDPlot[WhichDeltaPtx][WhichDeltaPty] = new TH1D("CCMECReco"+ECalTwoDInDeltaPtxDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty][0]);
				CCRESRecoECal_InDeltaPtxDeltaPtyTwoDPlot[WhichDeltaPtx][WhichDeltaPty] = new TH1D("CCRESReco"+ECalTwoDInDeltaPtxDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty][0]);
				CCDISRecoECal_InDeltaPtxDeltaPtyTwoDPlot[WhichDeltaPtx][WhichDeltaPty] = new TH1D("CCDISReco"+ECalTwoDInDeltaPtxDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty][0]);	
				CC1pRecoECal_InDeltaPtxDeltaPtyTwoDPlot2D[WhichDeltaPtx][WhichDeltaPty] = new TH2D("CC1pReco"+ECalTwoDInDeltaPtxDeltaPtyLabel+"2D",LabelXAxisECal2D,TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty][0],TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty][0]);	
				POTScaledCC1pRecoECal_InDeltaPtxDeltaPtyTwoDPlot2D[WhichDeltaPtx][WhichDeltaPty] = new TH2D("POTScaledCC1pReco"+ECalTwoDInDeltaPtxDeltaPtyLabel+"2D",LabelXAxisECal2D,TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty][0],TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices[WhichDeltaPtx][WhichDeltaPty][0]);																									

			} // End of the loop over the 2D DeltaPty bins
		...
		// ECal in DeltaPty slices

		TH1D* RecoECal_InDeltaPtyTwoDPlot[TwoDNBinsDeltaPty];
		TH1D* CC1pRecoECal_InDeltaPtyTwoDPlot[TwoDNBinsDeltaPty];
		TH1D* CC1pTrueECal_InDeltaPtyTwoDPlot[TwoDNBinsDeltaPty];				
		TH1D* NonCC1pRecoECal_InDeltaPtyTwoDPlot[TwoDNBinsDeltaPty];		
		TH1D* CCQERecoECal_InDeltaPtyTwoDPlot[TwoDNBinsDeltaPty];
		TH1D* CCMECRecoECal_InDeltaPtyTwoDPlot[TwoDNBinsDeltaPty];
		TH1D* CCRESRecoECal_InDeltaPtyTwoDPlot[TwoDNBinsDeltaPty];
		TH1D* CCDISRecoECal_InDeltaPtyTwoDPlot[TwoDNBinsDeltaPty];
		TH2D* CC1pRecoECal_InDeltaPtyTwoDPlot2D[TwoDNBinsDeltaPty];	
		TH2D* POTScaledCC1pRecoECal_InDeltaPtyTwoDPlot2D[TwoDNBinsDeltaPty];					
		...
		for (int WhichDeltaPty = 0; WhichDeltaPty < TwoDNBinsDeltaPty; WhichDeltaPty++) {	
			...
			RecoECal_InDeltaPtyTwoDPlot[WhichDeltaPty] = new TH1D("Reco"+ECalTwoDInDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty][0]);
			CC1pRecoECal_InDeltaPtyTwoDPlot[WhichDeltaPty] = new TH1D("CC1pReco"+ECalTwoDInDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty][0]);
			CC1pTrueECal_InDeltaPtyTwoDPlot[WhichDeltaPty] = new TH1D("CC1pTrue"+ECalTwoDInDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty][0]);					
			NonCC1pRecoECal_InDeltaPtyTwoDPlot[WhichDeltaPty] = new TH1D("NonCC1pReco"+ECalTwoDInDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty][0]);
			CCQERecoECal_InDeltaPtyTwoDPlot[WhichDeltaPty] = new TH1D("CCQEReco"+ECalTwoDInDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty][0]);
			CCMECRecoECal_InDeltaPtyTwoDPlot[WhichDeltaPty] = new TH1D("CCMECReco"+ECalTwoDInDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty][0]);
			CCRESRecoECal_InDeltaPtyTwoDPlot[WhichDeltaPty] = new TH1D("CCRESReco"+ECalTwoDInDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty][0]);
			CCDISRecoECal_InDeltaPtyTwoDPlot[WhichDeltaPty] = new TH1D("CCDISReco"+ECalTwoDInDeltaPtyLabel,LabelXAxisECal,TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty][0]);	
			CC1pRecoECal_InDeltaPtyTwoDPlot2D[WhichDeltaPty] = new TH2D("CC1pReco"+ECalTwoDInDeltaPtyLabel+"2D",LabelXAxisECal2D,TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty][0],TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty][0]);	
			POTScaledCC1pRecoECal_InDeltaPtyTwoDPlot2D[WhichDeltaPty] = new TH2D("POTScaledCC1pReco"+ECalTwoDInDeltaPtyLabel+"2D",LabelXAxisECal2D,TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty][0],TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty].size()-1,&TwoDArrayNBinsECalInDeltaPtySlices[WhichDeltaPty][0]);

		}		

		//----------------------------------------//

		// Proton Momentum in DeltaAlphaT slices

		TH1D* RecoProtonMomentum_InDeltaAlphaTTwoDPlot[TwoDNBinsDeltaAlphaT];
		TH1D* CC1pRecoProtonMomentum_InDeltaAlphaTTwoDPlot[TwoDNBinsDeltaAlphaT];
		TH1D* CC1pTrueProtonMomentum_InDeltaAlphaTTwoDPlot[TwoDNBinsDeltaAlphaT];				
		TH1D* NonCC1pRecoProtonMomentum_InDeltaAlphaTTwoDPlot[TwoDNBinsDeltaAlphaT];		
		TH1D* CCQERecoProtonMomentum_InDeltaAlphaTTwoDPlot[TwoDNBinsDeltaAlphaT];
		TH1D* CCMECRecoProtonMomentum_InDeltaAlphaTTwoDPlot[TwoDNBinsDeltaAlphaT];
		TH1D* CCRESRecoProtonMomentum_InDeltaAlphaTTwoDPlot[TwoDNBinsDeltaAlphaT];
		TH1D* CCDISRecoProtonMomentum_InDeltaAlphaTTwoDPlot[TwoDNBinsDeltaAlphaT];
		TH2D* CC1pRecoProtonMomentum_InDeltaAlphaTTwoDPlot2D[TwoDNBinsDeltaAlphaT];	
		TH2D* POTScaledCC1pRecoProtonMomentum_InDeltaAlphaTTwoDPlot2D[TwoDNBinsDeltaAlphaT];

		// DeltaPn in DeltaAlpha3Dq slices

		TH1D* RecoDeltaPn_InDeltaAlpha3DqTwoDPlot[TwoDNBinsDeltaAlpha3Dq];
		TH1D* CC1pRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[TwoDNBinsDeltaAlpha3Dq];
		TH1D* CC1pTrueDeltaPn_InDeltaAlpha3DqTwoDPlot[TwoDNBinsDeltaAlpha3Dq];				
		TH1D* NonCC1pRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[TwoDNBinsDeltaAlpha3Dq];		
		TH1D* CCQERecoDeltaPn_InDeltaAlpha3DqTwoDPlot[TwoDNBinsDeltaAlpha3Dq];
		TH1D* CCMECRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[TwoDNBinsDeltaAlpha3Dq];
		TH1D* CCRESRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[TwoDNBinsDeltaAlpha3Dq];
		TH1D* CCDISRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[TwoDNBinsDeltaAlpha3Dq];
		TH2D* CC1pRecoDeltaPn_InDeltaAlpha3DqTwoDPlot2D[TwoDNBinsDeltaAlpha3Dq];	
		TH2D* POTScaledCC1pRecoDeltaPn_InDeltaAlpha3DqTwoDPlot2D[TwoDNBinsDeltaAlpha3Dq];

		// DeltaPn in DeltaAlpha3DMu slices

		TH1D* RecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[TwoDNBinsDeltaAlpha3DMu];
		TH1D* CC1pRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[TwoDNBinsDeltaAlpha3DMu];
		TH1D* CC1pTrueDeltaPn_InDeltaAlpha3DMuTwoDPlot[TwoDNBinsDeltaAlpha3DMu];				
		TH1D* NonCC1pRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[TwoDNBinsDeltaAlpha3DMu];		
		TH1D* CCQERecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[TwoDNBinsDeltaAlpha3DMu];
		TH1D* CCMECRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[TwoDNBinsDeltaAlpha3DMu];
		TH1D* CCRESRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[TwoDNBinsDeltaAlpha3DMu];
		TH1D* CCDISRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[TwoDNBinsDeltaAlpha3DMu];
		TH2D* CC1pRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot2D[TwoDNBinsDeltaAlpha3DMu];	
		TH2D* POTScaledCC1pRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot2D[TwoDNBinsDeltaAlpha3DMu];		
		...
		for (int WhichDeltaAlpha3Dq = 0; WhichDeltaAlpha3Dq < TwoDNBinsDeltaAlpha3Dq; WhichDeltaAlpha3Dq++) {
			...
			RecoDeltaPn_InDeltaAlpha3DqTwoDPlot[WhichDeltaAlpha3Dq] = new TH1D("Reco"+DeltaPnTwoDInDeltaAlpha3DqLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq][0]);
			CC1pRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[WhichDeltaAlpha3Dq] = new TH1D("CC1pReco"+DeltaPnTwoDInDeltaAlpha3DqLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq][0]);
			CC1pTrueDeltaPn_InDeltaAlpha3DqTwoDPlot[WhichDeltaAlpha3Dq] = new TH1D("CC1pTrue"+DeltaPnTwoDInDeltaAlpha3DqLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq][0]);					
			NonCC1pRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[WhichDeltaAlpha3Dq] = new TH1D("NonCC1pReco"+DeltaPnTwoDInDeltaAlpha3DqLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq][0]);
			CCQERecoDeltaPn_InDeltaAlpha3DqTwoDPlot[WhichDeltaAlpha3Dq] = new TH1D("CCQEReco"+DeltaPnTwoDInDeltaAlpha3DqLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq][0]);
			CCMECRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[WhichDeltaAlpha3Dq] = new TH1D("CCMECReco"+DeltaPnTwoDInDeltaAlpha3DqLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq][0]);
			CCRESRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[WhichDeltaAlpha3Dq] = new TH1D("CCRESReco"+DeltaPnTwoDInDeltaAlpha3DqLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq][0]);
			CCDISRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[WhichDeltaAlpha3Dq] = new TH1D("CCDISReco"+DeltaPnTwoDInDeltaAlpha3DqLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq][0]);	
			CC1pRecoDeltaPn_InDeltaAlpha3DqTwoDPlot2D[WhichDeltaAlpha3Dq] = new TH2D("CC1pReco"+DeltaPnTwoDInDeltaAlpha3DqLabel+"2D",LabelXAxisDeltaPn2D,TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq][0],TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq][0]);	
			POTScaledCC1pRecoDeltaPn_InDeltaAlpha3DqTwoDPlot2D[WhichDeltaAlpha3Dq] = new TH2D("POTScaledCC1pReco"+DeltaPnTwoDInDeltaAlpha3DqLabel+"2D",LabelXAxisDeltaPn2D,TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq][0],TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices[WhichDeltaAlpha3Dq][0]);			
		...
		for (int WhichDeltaAlpha3DMu = 0; WhichDeltaAlpha3DMu < TwoDNBinsDeltaAlpha3DMu; WhichDeltaAlpha3DMu++) {
			...
			RecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[WhichDeltaAlpha3DMu] = new TH1D("Reco"+DeltaPnTwoDInDeltaAlpha3DMuLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu][0]);
			CC1pRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[WhichDeltaAlpha3DMu] = new TH1D("CC1pReco"+DeltaPnTwoDInDeltaAlpha3DMuLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu][0]);
			CC1pTrueDeltaPn_InDeltaAlpha3DMuTwoDPlot[WhichDeltaAlpha3DMu] = new TH1D("CC1pTrue"+DeltaPnTwoDInDeltaAlpha3DMuLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu][0]);					
			NonCC1pRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[WhichDeltaAlpha3DMu] = new TH1D("NonCC1pReco"+DeltaPnTwoDInDeltaAlpha3DMuLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu][0]);
			CCQERecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[WhichDeltaAlpha3DMu] = new TH1D("CCQEReco"+DeltaPnTwoDInDeltaAlpha3DMuLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu][0]);
			CCMECRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[WhichDeltaAlpha3DMu] = new TH1D("CCMECReco"+DeltaPnTwoDInDeltaAlpha3DMuLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu][0]);
			CCRESRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[WhichDeltaAlpha3DMu] = new TH1D("CCRESReco"+DeltaPnTwoDInDeltaAlpha3DMuLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu][0]);
			CCDISRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[WhichDeltaAlpha3DMu] = new TH1D("CCDISReco"+DeltaPnTwoDInDeltaAlpha3DMuLabel,LabelXAxisDeltaPn,TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu][0]);	
			CC1pRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot2D[WhichDeltaAlpha3DMu] = new TH2D("CC1pReco"+DeltaPnTwoDInDeltaAlpha3DMuLabel+"2D",LabelXAxisDeltaPn2D,TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu][0],TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu][0]);	
			POTScaledCC1pRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot2D[WhichDeltaAlpha3DMu] = new TH2D("POTScaledCC1pReco"+DeltaPnTwoDInDeltaAlpha3DMuLabel+"2D",LabelXAxisDeltaPn2D,TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu][0],TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu].size()-1,&TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices[WhichDeltaAlpha3DMu][0]);			
		...
		for (int WhichDeltaAlphaT = 0; WhichDeltaAlphaT < TwoDNBinsDeltaAlphaT; WhichDeltaAlphaT++) {	
			...
			RecoProtonMomentum_InDeltaAlphaTTwoDPlot[WhichDeltaAlphaT] = new TH1D("Reco"+ProtonMomentumTwoDInDeltaAlphaTLabel,LabelXAxisProtonMomentum,TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT].size()-1,&TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT][0]);
			CC1pRecoProtonMomentum_InDeltaAlphaTTwoDPlot[WhichDeltaAlphaT] = new TH1D("CC1pReco"+ProtonMomentumTwoDInDeltaAlphaTLabel,LabelXAxisProtonMomentum,TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT].size()-1,&TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT][0]);
			CC1pTrueProtonMomentum_InDeltaAlphaTTwoDPlot[WhichDeltaAlphaT] = new TH1D("CC1pTrue"+ProtonMomentumTwoDInDeltaAlphaTLabel,LabelXAxisProtonMomentum,TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT].size()-1,&TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT][0]);					
			NonCC1pRecoProtonMomentum_InDeltaAlphaTTwoDPlot[WhichDeltaAlphaT] = new TH1D("NonCC1pReco"+ProtonMomentumTwoDInDeltaAlphaTLabel,LabelXAxisProtonMomentum,TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT].size()-1,&TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT][0]);
			CCQERecoProtonMomentum_InDeltaAlphaTTwoDPlot[WhichDeltaAlphaT] = new TH1D("CCQEReco"+ProtonMomentumTwoDInDeltaAlphaTLabel,LabelXAxisProtonMomentum,TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT].size()-1,&TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT][0]);
			CCMECRecoProtonMomentum_InDeltaAlphaTTwoDPlot[WhichDeltaAlphaT] = new TH1D("CCMECReco"+ProtonMomentumTwoDInDeltaAlphaTLabel,LabelXAxisProtonMomentum,TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT].size()-1,&TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT][0]);
			CCRESRecoProtonMomentum_InDeltaAlphaTTwoDPlot[WhichDeltaAlphaT] = new TH1D("CCRESReco"+ProtonMomentumTwoDInDeltaAlphaTLabel,LabelXAxisProtonMomentum,TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT].size()-1,&TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT][0]);
			CCDISRecoProtonMomentum_InDeltaAlphaTTwoDPlot[WhichDeltaAlphaT] = new TH1D("CCDISReco"+ProtonMomentumTwoDInDeltaAlphaTLabel,LabelXAxisProtonMomentum,TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT].size()-1,&TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT][0]);	
			CC1pRecoProtonMomentum_InDeltaAlphaTTwoDPlot2D[WhichDeltaAlphaT] = new TH2D("CC1pReco"+ProtonMomentumTwoDInDeltaAlphaTLabel+"2D",LabelXAxisProtonMomentum2D,TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT].size()-1,&TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT][0],TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT].size()-1,&TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT][0]);	
			POTScaledCC1pRecoProtonMomentum_InDeltaAlphaTTwoDPlot2D[WhichDeltaAlphaT] = new TH2D("POTScaledCC1pReco"+ProtonMomentumTwoDInDeltaAlphaTLabel+"2D",LabelXAxisProtonMomentum2D,TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT].size()-1,&TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT][0],TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT].size()-1,&TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices[WhichDeltaAlphaT][0]);
		...
		// DeltaAlphaT in muon momentum bins
		TH1D* SerialRecoDeltaAlphaT_InMuonMomentumPlot = new TH1D("RecoSerialDeltaAlphaT_MuonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices)[0]);
		TH1D* SerialCC1pRecoDeltaAlphaT_InMuonMomentumPlot = new TH1D("CC1pRecoSerialDeltaAlphaT_MuonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices)[0]);
		TH1D* SerialCC1pTrueDeltaAlphaT_InMuonMomentumPlot = new TH1D("CC1pTrueSerialDeltaAlphaT_MuonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices)[0]);		
		TH1D* SerialNonCC1pRecoDeltaAlphaT_InMuonMomentumPlot = new TH1D("NonCC1pRecoSerialDeltaAlphaT_MuonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices)[0]);
		TH1D* SerialCCQERecoDeltaAlphaT_InMuonMomentumPlot = new TH1D("CCQERecoSerialDeltaAlphaT_MuonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices)[0]);
		TH1D* SerialCCMECRecoDeltaAlphaT_InMuonMomentumPlot = new TH1D("CCMECRecoSerialDeltaAlphaT_MuonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices)[0]);								
		TH1D* SerialCCRESRecoDeltaAlphaT_InMuonMomentumPlot = new TH1D("CCRESRecoSerialDeltaAlphaT_MuonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices)[0]);
		TH1D* SerialCCDISRecoDeltaAlphaT_InMuonMomentumPlot = new TH1D("CCDISRecoSerialDeltaAlphaT_MuonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices)[0]);
		TH2D* SerialCC1pRecoDeltaAlphaT_InMuonMomentumPlot2D = new TH2D("CC1pRecoSerialDeltaAlphaT_MuonMomentumPlot2D",LabelXAxisDeltaAlphaT2D,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices)[0],tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices)[0]);
		TH2D* SerialPOTScaledCC1pRecoDeltaAlphaT_InMuonMomentumPlot2D = new TH2D("POTScaledCC1pRecoSerialDeltaAlphaT_MuonMomentumPlot2D",LabelXAxisDeltaAlphaT2D,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices)[0],tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices)[0]);
		...
		// DeltaAlphaT in proton momentum bins
		TH1D* SerialRecoDeltaAlphaT_InProtonMomentumPlot = new TH1D("RecoSerialDeltaAlphaT_ProtonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices)[0]);
		TH1D* SerialCC1pRecoDeltaAlphaT_InProtonMomentumPlot = new TH1D("CC1pRecoSerialDeltaAlphaT_ProtonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices)[0]);
		TH1D* SerialCC1pTrueDeltaAlphaT_InProtonMomentumPlot = new TH1D("CC1pTrueSerialDeltaAlphaT_ProtonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices)[0]);		
		TH1D* SerialNonCC1pRecoDeltaAlphaT_InProtonMomentumPlot = new TH1D("NonCC1pRecoSerialDeltaAlphaT_ProtonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices)[0]);
		TH1D* SerialCCQERecoDeltaAlphaT_InProtonMomentumPlot = new TH1D("CCQERecoSerialDeltaAlphaT_ProtonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices)[0]);
		TH1D* SerialCCMECRecoDeltaAlphaT_InProtonMomentumPlot = new TH1D("CCMECRecoSerialDeltaAlphaT_ProtonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices)[0]);								
		TH1D* SerialCCRESRecoDeltaAlphaT_InProtonMomentumPlot = new TH1D("CCRESRecoSerialDeltaAlphaT_ProtonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices)[0]);
		TH1D* SerialCCDISRecoDeltaAlphaT_InProtonMomentumPlot = new TH1D("CCDISRecoSerialDeltaAlphaT_ProtonMomentumPlot",LabelXAxisDeltaAlphaT,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices)[0]);
		TH2D* SerialCC1pRecoDeltaAlphaT_InProtonMomentumPlot2D = new TH2D("CC1pRecoSerialDeltaAlphaT_ProtonMomentumPlot2D",LabelXAxisDeltaAlphaT2D,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices)[0],tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices)[0]);
		TH2D* SerialPOTScaledCC1pRecoDeltaAlphaT_InProtonMomentumPlot2D = new TH2D("POTScaledCC1pRecoSerialDeltaAlphaT_ProtonMomentumPlot2D",LabelXAxisDeltaAlphaT2D,tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices)[0],tools.Return2DNBins(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices)[0]);		

		// DeltaAlpha3Dq in DeltaPn bins
		TH1D* SerialRecoDeltaAlpha3Dq_InDeltaPnPlot = new TH1D("RecoSerialDeltaAlpha3Dq_DeltaPnPlot",LabelXAxisDeltaAlpha3Dq,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices)[0]);		
		TH1D* SerialCC1pRecoDeltaAlpha3Dq_InDeltaPnPlot = new TH1D("CC1pRecoSerialDeltaAlpha3Dq_DeltaPnPlot",LabelXAxisDeltaAlpha3Dq,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices)[0]);
		TH1D* SerialCC1pTrueDeltaAlpha3Dq_InDeltaPnPlot = new TH1D("CC1pTrueSerialDeltaAlpha3Dq_DeltaPnPlot",LabelXAxisDeltaAlpha3Dq,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices)[0]);		
		TH1D* SerialNonCC1pRecoDeltaAlpha3Dq_InDeltaPnPlot = new TH1D("NonCC1pRecoSerialDeltaAlpha3Dq_DeltaPnPlot",LabelXAxisDeltaAlpha3Dq,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices)[0]);
		TH1D* SerialCCQERecoDeltaAlpha3Dq_InDeltaPnPlot = new TH1D("CCQERecoSerialDeltaAlpha3Dq_DeltaPnPlot",LabelXAxisDeltaAlpha3Dq,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices)[0]);
		TH1D* SerialCCMECRecoDeltaAlpha3Dq_InDeltaPnPlot = new TH1D("CCMECRecoSerialDeltaAlpha3Dq_DeltaPnPlot",LabelXAxisDeltaAlpha3Dq,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices)[0]);								
		TH1D* SerialCCRESRecoDeltaAlpha3Dq_InDeltaPnPlot = new TH1D("CCRESRecoSerialDeltaAlpha3Dq_DeltaPnPlot",LabelXAxisDeltaAlpha3Dq,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices)[0]);
		TH1D* SerialCCDISRecoDeltaAlpha3Dq_InDeltaPnPlot = new TH1D("CCDISRecoSerialDeltaAlpha3Dq_DeltaPnPlot",LabelXAxisDeltaAlpha3Dq,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices)[0]);
		TH2D* SerialCC1pRecoDeltaAlpha3Dq_InDeltaPnPlot2D = new TH2D("CC1pRecoSerialDeltaAlpha3Dq_DeltaPnPlot2D",LabelXAxisDeltaAlpha3Dq2D,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices)[0],tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices)[0]);
		TH2D* SerialPOTScaledCC1pRecoDeltaAlpha3Dq_InDeltaPnPlot2D = new TH2D("POTScaledCC1pRecoSerialDeltaAlpha3Dq_DeltaPnPlot2D",LabelXAxisDeltaAlpha3Dq2D,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices)[0],tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices)[0]);

		// DeltaAlpha3DMu in DeltaPn bins
		TH1D* SerialRecoDeltaAlpha3DMu_InDeltaPnPlot = new TH1D("RecoSerialDeltaAlpha3DMu_DeltaPnPlot",LabelXAxisDeltaAlpha3DMu,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices)[0]);		
		TH1D* SerialCC1pRecoDeltaAlpha3DMu_InDeltaPnPlot = new TH1D("CC1pRecoSerialDeltaAlpha3DMu_DeltaPnPlot",LabelXAxisDeltaAlpha3DMu,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices)[0]);
		TH1D* SerialCC1pTrueDeltaAlpha3DMu_InDeltaPnPlot = new TH1D("CC1pTrueSerialDeltaAlpha3DMu_DeltaPnPlot",LabelXAxisDeltaAlpha3DMu,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices)[0]);		
		TH1D* SerialNonCC1pRecoDeltaAlpha3DMu_InDeltaPnPlot = new TH1D("NonCC1pRecoSerialDeltaAlpha3DMu_DeltaPnPlot",LabelXAxisDeltaAlpha3DMu,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices)[0]);
		TH1D* SerialCCQERecoDeltaAlpha3DMu_InDeltaPnPlot = new TH1D("CCQERecoSerialDeltaAlpha3DMu_DeltaPnPlot",LabelXAxisDeltaAlpha3DMu,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices)[0]);
		TH1D* SerialCCMECRecoDeltaAlpha3DMu_InDeltaPnPlot = new TH1D("CCMECRecoSerialDeltaAlpha3DMu_DeltaPnPlot",LabelXAxisDeltaAlpha3DMu,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices)[0]);								
		TH1D* SerialCCRESRecoDeltaAlpha3DMu_InDeltaPnPlot = new TH1D("CCRESRecoSerialDeltaAlpha3DMu_DeltaPnPlot",LabelXAxisDeltaAlpha3DMu,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices)[0]);
		TH1D* SerialCCDISRecoDeltaAlpha3DMu_InDeltaPnPlot = new TH1D("CCDISRecoSerialDeltaAlpha3DMu_DeltaPnPlot",LabelXAxisDeltaAlpha3DMu,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices)[0]);
		TH2D* SerialCC1pRecoDeltaAlpha3DMu_InDeltaPnPlot2D = new TH2D("CC1pRecoSerialDeltaAlpha3DMu_DeltaPnPlot2D",LabelXAxisDeltaAlpha3DMu2D,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices)[0],tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices)[0]);
		TH2D* SerialPOTScaledCC1pRecoDeltaAlpha3DMu_InDeltaPnPlot2D = new TH2D("POTScaledCC1pRecoSerialDeltaAlpha3DMu_DeltaPnPlot2D",LabelXAxisDeltaAlpha3DMu2D,tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices)[0],tools.Return2DNBins(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices)[0]);		
		...
		// ProtonMomentum in DeltaAlphaT bins
		TH1D* SerialRecoProtonMomentum_InDeltaAlphaTPlot = new TH1D("RecoSerialProtonMomentum_DeltaAlphaTPlot",LabelXAxisProtonMomentum,tools.Return2DNBins(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices),&tools.Return2DBinIndices(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices)[0]);		
		TH1D* SerialCC1pRecoProtonMomentum_InDeltaAlphaTPlot = new TH1D("CC1pRecoSerialProtonMomentum_DeltaAlphaTPlot",LabelXAxisProtonMomentum,tools.Return2DNBins(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices),&tools.Return2DBinIndices(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices)[0]);
		TH1D* SerialCC1pTrueProtonMomentum_InDeltaAlphaTPlot = new TH1D("CC1pTrueSerialProtonMomentum_DeltaAlphaTPlot",LabelXAxisProtonMomentum,tools.Return2DNBins(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices),&tools.Return2DBinIndices(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices)[0]);		
		TH1D* SerialNonCC1pRecoProtonMomentum_InDeltaAlphaTPlot = new TH1D("NonCC1pRecoSerialProtonMomentum_DeltaAlphaTPlot",LabelXAxisProtonMomentum,tools.Return2DNBins(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices),&tools.Return2DBinIndices(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices)[0]);
		TH1D* SerialCCQERecoProtonMomentum_InDeltaAlphaTPlot = new TH1D("CCQERecoSerialProtonMomentum_DeltaAlphaTPlot",LabelXAxisProtonMomentum,tools.Return2DNBins(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices),&tools.Return2DBinIndices(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices)[0]);
		TH1D* SerialCCMECRecoProtonMomentum_InDeltaAlphaTPlot = new TH1D("CCMECRecoSerialProtonMomentum_DeltaAlphaTPlot",LabelXAxisProtonMomentum,tools.Return2DNBins(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices),&tools.Return2DBinIndices(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices)[0]);								
		TH1D* SerialCCRESRecoProtonMomentum_InDeltaAlphaTPlot = new TH1D("CCRESRecoSerialProtonMomentum_DeltaAlphaTPlot",LabelXAxisProtonMomentum,tools.Return2DNBins(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices),&tools.Return2DBinIndices(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices)[0]);
		TH1D* SerialCCDISRecoProtonMomentum_InDeltaAlphaTPlot = new TH1D("CCDISRecoSerialProtonMomentum_DeltaAlphaTPlot",LabelXAxisProtonMomentum,tools.Return2DNBins(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices),&tools.Return2DBinIndices(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices)[0]);
		TH2D* SerialCC1pRecoProtonMomentum_InDeltaAlphaTPlot2D = new TH2D("CC1pRecoSerialProtonMomentum_DeltaAlphaTPlot2D",LabelXAxisProtonMomentum2D,tools.Return2DNBins(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices),&tools.Return2DBinIndices(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices)[0],tools.Return2DNBins(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices),&tools.Return2DBinIndices(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices)[0]);
		TH2D* SerialPOTScaledCC1pRecoProtonMomentum_InDeltaAlphaTPlot2D = new TH2D("POTScaledCC1pRecoSerialProtonMomentum_DeltaAlphaTPlot2D",LabelXAxisProtonMomentum2D,tools.Return2DNBins(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices),&tools.Return2DBinIndices(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices)[0],tools.Return2DNBins(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices),&tools.Return2DBinIndices(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices)[0]);
		...
		// DeltaPn in DeltaAlpha3Dq bins
		TH1D* SerialRecoDeltaPn_InDeltaAlpha3DqPlot = new TH1D("RecoSerialDeltaPn_DeltaAlpha3DqPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices)[0]);		
		TH1D* SerialCC1pRecoDeltaPn_InDeltaAlpha3DqPlot = new TH1D("CC1pRecoSerialDeltaPn_DeltaAlpha3DqPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices)[0]);
		TH1D* SerialCC1pTrueDeltaPn_InDeltaAlpha3DqPlot = new TH1D("CC1pTrueSerialDeltaPn_DeltaAlpha3DqPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices)[0]);		
		TH1D* SerialNonCC1pRecoDeltaPn_InDeltaAlpha3DqPlot = new TH1D("NonCC1pRecoSerialDeltaPn_DeltaAlpha3DqPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices)[0]);
		TH1D* SerialCCQERecoDeltaPn_InDeltaAlpha3DqPlot = new TH1D("CCQERecoSerialDeltaPn_DeltaAlpha3DqPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices)[0]);
		TH1D* SerialCCMECRecoDeltaPn_InDeltaAlpha3DqPlot = new TH1D("CCMECRecoSerialDeltaPn_DeltaAlpha3DqPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices)[0]);								
		TH1D* SerialCCRESRecoDeltaPn_InDeltaAlpha3DqPlot = new TH1D("CCRESRecoSerialDeltaPn_DeltaAlpha3DqPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices)[0]);
		TH1D* SerialCCDISRecoDeltaPn_InDeltaAlpha3DqPlot = new TH1D("CCDISRecoSerialDeltaPn_DeltaAlpha3DqPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices)[0]);
		TH2D* SerialCC1pRecoDeltaPn_InDeltaAlpha3DqPlot2D = new TH2D("CC1pRecoSerialDeltaPn_DeltaAlpha3DqPlot2D",LabelXAxisDeltaPn2D,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices)[0],tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices)[0]);
		TH2D* SerialPOTScaledCC1pRecoDeltaPn_InDeltaAlpha3DqPlot2D = new TH2D("POTScaledCC1pRecoSerialDeltaPn_DeltaAlpha3DqPlot2D",LabelXAxisDeltaPn2D,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices)[0],tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices)[0]);

		// DeltaPn in DeltaAlpha3DMu bins
		TH1D* SerialRecoDeltaPn_InDeltaAlpha3DMuPlot = new TH1D("RecoSerialDeltaPn_DeltaAlpha3DMuPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices)[0]);		
		TH1D* SerialCC1pRecoDeltaPn_InDeltaAlpha3DMuPlot = new TH1D("CC1pRecoSerialDeltaPn_DeltaAlpha3DMuPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices)[0]);
		TH1D* SerialCC1pTrueDeltaPn_InDeltaAlpha3DMuPlot = new TH1D("CC1pTrueSerialDeltaPn_DeltaAlpha3DMuPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices)[0]);		
		TH1D* SerialNonCC1pRecoDeltaPn_InDeltaAlpha3DMuPlot = new TH1D("NonCC1pRecoSerialDeltaPn_DeltaAlpha3DMuPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices)[0]);
		TH1D* SerialCCQERecoDeltaPn_InDeltaAlpha3DMuPlot = new TH1D("CCQERecoSerialDeltaPn_DeltaAlpha3DMuPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices)[0]);
		TH1D* SerialCCMECRecoDeltaPn_InDeltaAlpha3DMuPlot = new TH1D("CCMECRecoSerialDeltaPn_DeltaAlpha3DMuPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices)[0]);								
		TH1D* SerialCCRESRecoDeltaPn_InDeltaAlpha3DMuPlot = new TH1D("CCRESRecoSerialDeltaPn_DeltaAlpha3DMuPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices)[0]);
		TH1D* SerialCCDISRecoDeltaPn_InDeltaAlpha3DMuPlot = new TH1D("CCDISRecoSerialDeltaPn_DeltaAlpha3DMuPlot",LabelXAxisDeltaPn,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices)[0]);
		TH2D* SerialCC1pRecoDeltaPn_InDeltaAlpha3DMuPlot2D = new TH2D("CC1pRecoSerialDeltaPn_DeltaAlpha3DMuPlot2D",LabelXAxisDeltaPn2D,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices)[0],tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices)[0]);
		TH2D* SerialPOTScaledCC1pRecoDeltaPn_InDeltaAlpha3DMuPlot2D = new TH2D("POTScaledCC1pRecoSerialDeltaPn_DeltaAlpha3DMuPlot2D",LabelXAxisDeltaPn2D,tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices)[0],tools.Return2DNBins(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices),&tools.Return2DBinIndices(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices)[0]);						
		...
		// ECal in DeltaPtx bins
		TH1D* SerialRecoECal_InDeltaPtxPlot = new TH1D("RecoSerialECal_DeltaPtxPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtxSlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtxSlices)[0]);
		TH1D* SerialCC1pRecoECal_InDeltaPtxPlot = new TH1D("CC1pRecoSerialECal_DeltaPtxPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtxSlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtxSlices)[0]);
		TH1D* SerialCC1pTrueECal_InDeltaPtxPlot = new TH1D("CC1pTrueSerialECal_DeltaPtxPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtxSlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtxSlices)[0]);		
		TH1D* SerialNonCC1pRecoECal_InDeltaPtxPlot = new TH1D("NonCC1pRecoSerialECal_DeltaPtxPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtxSlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtxSlices)[0]);
		TH1D* SerialCCQERecoECal_InDeltaPtxPlot = new TH1D("CCQERecoSerialECal_DeltaPtxPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtxSlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtxSlices)[0]);
		TH1D* SerialCCMECRecoECal_InDeltaPtxPlot = new TH1D("CCMECRecoSerialECal_DeltaPtxPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtxSlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtxSlices)[0]);								
		TH1D* SerialCCRESRecoECal_InDeltaPtxPlot = new TH1D("CCRESRecoSerialECal_DeltaPtxPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtxSlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtxSlices)[0]);
		TH1D* SerialCCDISRecoECal_InDeltaPtxPlot = new TH1D("CCDISRecoSerialECal_DeltaPtxPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtxSlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtxSlices)[0]);
		TH2D* SerialCC1pRecoECal_InDeltaPtxPlot2D = new TH2D("CC1pRecoSerialECal_DeltaPtxPlot2D",LabelXAxisECal2D,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtxSlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtxSlices)[0],tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtxSlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtxSlices)[0]);
		TH2D* SerialPOTScaledCC1pRecoECal_InDeltaPtxPlot2D = new TH2D("POTScaledCC1pRecoSerialECal_DeltaPtxPlot2D",LabelXAxisECal2D,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtxSlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtxSlices)[0],tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtxSlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtxSlices)[0]);

		// ECal in DeltaPty bins
		TH1D* SerialRecoECal_InDeltaPtyPlot = new TH1D("RecoSerialECal_DeltaPtyPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtySlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtySlices)[0]);
		TH1D* SerialCC1pRecoECal_InDeltaPtyPlot = new TH1D("CC1pRecoSerialECal_DeltaPtyPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtySlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtySlices)[0]);
		TH1D* SerialCC1pTrueECal_InDeltaPtyPlot = new TH1D("CC1pTrueSerialECal_DeltaPtyPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtySlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtySlices)[0]);		
		TH1D* SerialNonCC1pRecoECal_InDeltaPtyPlot = new TH1D("NonCC1pRecoSerialECal_DeltaPtyPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtySlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtySlices)[0]);
		TH1D* SerialCCQERecoECal_InDeltaPtyPlot = new TH1D("CCQERecoSerialECal_DeltaPtyPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtySlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtySlices)[0]);
		TH1D* SerialCCMECRecoECal_InDeltaPtyPlot = new TH1D("CCMECRecoSerialECal_DeltaPtyPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtySlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtySlices)[0]);								
		TH1D* SerialCCRESRecoECal_InDeltaPtyPlot = new TH1D("CCRESRecoSerialECal_DeltaPtyPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtySlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtySlices)[0]);
		TH1D* SerialCCDISRecoECal_InDeltaPtyPlot = new TH1D("CCDISRecoSerialECal_DeltaPtyPlot",LabelXAxisECal,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtySlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtySlices)[0]);
		TH2D* SerialCC1pRecoECal_InDeltaPtyPlot2D = new TH2D("CC1pRecoSerialECal_DeltaPtyPlot2D",LabelXAxisECal2D,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtySlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtySlices)[0],tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtySlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtySlices)[0]);
		TH2D* SerialPOTScaledCC1pRecoECal_InDeltaPtyPlot2D = new TH2D("POTScaledCC1pRecoSerialECal_DeltaPtyPlot2D",LabelXAxisECal2D,tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtySlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtySlices)[0],tools.Return2DNBins(TwoDArrayNBinsECalInDeltaPtySlices),&tools.Return2DBinIndices(TwoDArrayNBinsECalInDeltaPtySlices)[0]);				
		...
		// ECal in DeltaPtx & DeltaPty bins
		TH1D* SerialRecoECal_InDeltaPtxDeltaPtyPlot = new TH1D("RecoSerialECal_DeltaPtxDeltaPtyPlot",LabelXAxisECal,tools.Return3DNBins(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices),&tools.Return3DBinIndices(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices)[0]);
		TH1D* SerialCC1pRecoECal_InDeltaPtxDeltaPtyPlot = new TH1D("CC1pRecoSerialECal_DeltaPtxDeltaPtyPlot",LabelXAxisECal,tools.Return3DNBins(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices),&tools.Return3DBinIndices(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices)[0]);
		TH1D* SerialCC1pTrueECal_InDeltaPtxDeltaPtyPlot = new TH1D("CC1pTrueSerialECal_DeltaPtxDeltaPtyPlot",LabelXAxisECal,tools.Return3DNBins(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices),&tools.Return3DBinIndices(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices)[0]);		
		TH1D* SerialNonCC1pRecoECal_InDeltaPtxDeltaPtyPlot = new TH1D("NonCC1pRecoSerialECal_DeltaPtxDeltaPtyPlot",LabelXAxisECal,tools.Return3DNBins(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices),&tools.Return3DBinIndices(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices)[0]);
		TH1D* SerialCCQERecoECal_InDeltaPtxDeltaPtyPlot = new TH1D("CCQERecoSerialECal_DeltaPtxDeltaPtyPlot",LabelXAxisECal,tools.Return3DNBins(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices),&tools.Return3DBinIndices(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices)[0]);
		TH1D* SerialCCMECRecoECal_InDeltaPtxDeltaPtyPlot = new TH1D("CCMECRecoSerialECal_DeltaPtxDeltaPtyPlot",LabelXAxisECal,tools.Return3DNBins(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices),&tools.Return3DBinIndices(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices)[0]);								
		TH1D* SerialCCRESRecoECal_InDeltaPtxDeltaPtyPlot = new TH1D("CCRESRecoSerialECal_DeltaPtxDeltaPtyPlot",LabelXAxisECal,tools.Return3DNBins(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices),&tools.Return3DBinIndices(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices)[0]);
		TH1D* SerialCCDISRecoECal_InDeltaPtxDeltaPtyPlot = new TH1D("CCDISRecoSerialECal_DeltaPtxDeltaPtyPlot",LabelXAxisECal,tools.Return3DNBins(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices),&tools.Return3DBinIndices(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices)[0]);
		TH2D* SerialCC1pRecoECal_InDeltaPtxDeltaPtyPlot2D = new TH2D("CC1pRecoSerialECal_DeltaPtxDeltaPtyPlot2D",LabelXAxisECal2D,tools.Return3DNBins(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices),&tools.Return3DBinIndices(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices)[0],tools.Return3DNBins(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices),&tools.Return3DBinIndices(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices)[0]);
		TH2D* SerialPOTScaledCC1pRecoECal_InDeltaPtxDeltaPtyPlot2D = new TH2D("POTScaledCC1pRecoSerialECal_DeltaPtxDeltaPtyPlot2D",LabelXAxisECal2D,tools.Return3DNBins(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices),&tools.Return3DBinIndices(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices)[0],tools.Return3DNBins(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices),&tools.Return3DBinIndices(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices)[0]);
...
//			double reco_Tp = reco_Ep - ProtonMass_GeV;
			...
			double DeltaAlpha3DMu = Reco_DeltaAlpha3DMu->at(0);						
			...
			if (reco_Pp < 0.5) { 
				...
				DeltaAlpha3DMu = reco_stv_tool.ReturnDeltaAlpha3DMu();						
...
//			if (reco_Q2 > ArrayNBinsQ2[NBinsQ2]) { continue; }
			...
			if (
				...
				true_DeltaAlpha3DMu = True_DeltaAlpha3DMu->at(0);								
			...
			int SerialDeltaAlphaTInMuonMomentumIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices,MuonMomentumTwoDIndex,DeltaAlphaT);			
			...
			int SerialDeltaAlphaTInProtonMomentumIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices,ProtonMomentumTwoDIndex,DeltaAlphaT);			
			...
			int SerialDeltaPnInDeltaAlpha3DqIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices,DeltaAlpha3DqTwoDIndex,reco_Pn);
			int SerialDeltaPnInDeltaAlpha3DMuIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices,DeltaAlpha3DMuTwoDIndex,reco_Pn);						
			int SerialProtonMomentumInDeltaAlphaTIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices,DeltaAlphaTTwoDIndex,reco_Pp);			
...
//			RecodProtonTracksScorePlot->Fill(ProtonTrackScore,weight);
			...
			RecoDeltaAlpha3DMuPlot->Fill(DeltaAlpha3DMu,weight);					
			...
			RecoECal_InDeltaPtxDeltaPtyTwoDPlot[DeltaPtxTwoDIndex][DeltaPtyTwoDIndex]->Fill(ECal,weight);			
			...
			RecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3Dq,weight);
			RecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3DMu,weight);						
			RecoDeltaPT_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(TransMissMomentum,weight);
			RecoDeltaPn_InDeltaAlpha3DqTwoDPlot[DeltaAlpha3DqTwoDIndex]->Fill(reco_Pn,weight);
			RecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[DeltaAlpha3DMuTwoDIndex]->Fill(reco_Pn,weight);						
			RecoProtonMomentum_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(reco_Pp,weight);			
			...
			RecoECal_InDeltaPtxTwoDPlot[DeltaPtxTwoDIndex]->Fill(ECal,weight);
			RecoECal_InDeltaPtyTwoDPlot[DeltaPtyTwoDIndex]->Fill(ECal,weight);															
			RecoDeltaAlphaT_InMuonCosThetaTwoDPlot[MuonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
			RecoDeltaAlphaT_InMuonMomentumTwoDPlot[MuonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);			
			RecoDeltaAlphaT_InProtonCosThetaTwoDPlot[ProtonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
			RecoDeltaAlphaT_InProtonMomentumTwoDPlot[ProtonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);						
			...
			SerialRecoDeltaAlphaT_InMuonMomentumPlot->Fill(SerialDeltaAlphaTInMuonMomentumIndex,weight);			
			SerialRecoDeltaAlphaT_InProtonCosThetaPlot->Fill(SerialDeltaAlphaTInProtonCosThetaIndex,weight);
			SerialRecoDeltaAlphaT_InProtonMomentumPlot->Fill(SerialDeltaAlphaTInProtonMomentumIndex,weight);			
			SerialRecoDeltaAlphaT_InDeltaPTPlot->Fill(SerialDeltaAlphaTInDeltaPTIndex,weight);
			SerialRecoDeltaAlpha3Dq_InDeltaPnPlot->Fill(SerialDeltaAlpha3DqInDeltaPnIndex,weight);
			SerialRecoDeltaAlpha3DMu_InDeltaPnPlot->Fill(SerialDeltaAlpha3DMuInDeltaPnIndex,weight);						
			SerialRecoDeltaPT_InDeltaAlphaTPlot->Fill(SerialDeltaPTInDeltaAlphaTIndex,weight);
			SerialRecoDeltaPn_InDeltaAlpha3DqPlot->Fill(SerialDeltaPnInDeltaAlpha3DqIndex,weight);
			SerialRecoDeltaPn_InDeltaAlpha3DMuPlot->Fill(SerialDeltaPnInDeltaAlpha3DMuIndex,weight);						
			SerialRecoProtonMomentum_InDeltaAlphaTPlot->Fill(SerialProtonMomentumInDeltaAlphaTIndex,weight);			
			...
			SerialRecoECal_InDeltaPtxPlot->Fill(SerialECalInDeltaPtxIndex,weight);
			SerialRecoECal_InDeltaPtyPlot->Fill(SerialECalInDeltaPtyIndex,weight);																													
			...
			SerialRecoECal_InDeltaPtxDeltaPtyPlot->Fill(SerialECalInDeltaPtxDeltaPtyIndex,weight);			
...
//				TVector3 True_CandidateProtonVertex(True_CandidateP_StartX->at(0),True_CandidateP_StartY->at(0),True_CandidateP_StartZ->at(0));
				...
				if ( CC1p == 1 && NumberPi0 == 0 && CandidateMu_MCParticle_Pdg->at(0) == MuonPdg 
					...
					CC1pTrueVertexYPlot->Fill(True_Vy,weight);
					CC1pTrueVertexZPlot->Fill(True_Vz,weight);
					...
					CC1pTrueDeltaAlpha3DMuPlot->Fill(true_DeltaAlpha3DMu,weight);										
					...
					int TrueDeltaAlpha3DMuTwoDIndex = tools.ReturnIndex(true_DeltaAlpha3DMu, TwoDArrayNBinsDeltaAlpha3DMu);										
					...
					int TrueSerialDeltaAlphaTInMuonMomentumIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsDeltaAlphaTInMuonMomentumSlices,TrueMuonMomentumTwoDIndex,true_DeltaAlphaT);					
					...
					int TrueSerialDeltaAlphaTInProtonMomentumIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsDeltaAlphaTInProtonMomentumSlices,TrueProtonMomentumTwoDIndex,true_DeltaAlphaT);					
					...
					int TrueSerialDeltaAlpha3DqInDeltaPnIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsDeltaAlpha3DqInDeltaPnSlices,TrueDeltaPnTwoDIndex,true_DeltaAlpha3Dq);
					int TrueSerialDeltaAlpha3DMuInDeltaPnIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsDeltaAlpha3DMuInDeltaPnSlices,TrueDeltaPnTwoDIndex,true_DeltaAlpha3DMu);									
					...
					int TrueSerialDeltaPnInDeltaAlpha3DqIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsDeltaPnInDeltaAlpha3DqSlices,TrueDeltaAlpha3DqTwoDIndex,true_Pn);
					int TrueSerialDeltaPnInDeltaAlpha3DMuIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsDeltaPnInDeltaAlpha3DMuSlices,TrueDeltaAlpha3DMuTwoDIndex,true_Pn);										
					int TrueSerialProtonMomentumInDeltaAlphaTIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsProtonMomentumInDeltaAlphaTSlices,TrueDeltaAlphaTTwoDIndex,True_CandidateP_P->at(0));
					...
					int TrueSerialECalInDeltaPtxIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsECalInDeltaPtxSlices,TrueDeltaPtxTwoDIndex,true_ECal);
					int TrueSerialECalInDeltaPtyIndex = tools.ReturnIndexIn2DList(TwoDArrayNBinsECalInDeltaPtySlices,TrueDeltaPtyTwoDIndex,true_ECal);																									
					...
					SerialCC1pTrueDeltaPn_InDeltaAlpha3DqPlot->Fill(TrueSerialDeltaPnInDeltaAlpha3DqIndex,weight);
					SerialCC1pTrueDeltaPn_InDeltaAlpha3DMuPlot->Fill(TrueSerialDeltaPnInDeltaAlpha3DMuIndex,weight);					
					SerialCC1pTrueProtonMomentum_InDeltaAlphaTPlot->Fill(TrueSerialProtonMomentumInDeltaAlphaTIndex,weight);										
					...
					SerialCC1pTrueDeltaAlphaT_InMuonMomentumPlot->Fill(TrueSerialDeltaAlphaTInMuonMomentumIndex,weight);
					SerialCC1pTrueDeltaAlphaT_InProtonCosThetaPlot->Fill(TrueSerialDeltaAlphaTInProtonCosThetaIndex,weight);
					SerialCC1pTrueDeltaAlphaT_InProtonMomentumPlot->Fill(TrueSerialDeltaAlphaTInProtonMomentumIndex,weight);					
					SerialCC1pTrueDeltaAlphaT_InDeltaPTPlot->Fill(TrueSerialDeltaAlphaTInDeltaPTIndex,weight);
					SerialCC1pTrueDeltaAlpha3Dq_InDeltaPnPlot->Fill(TrueSerialDeltaAlpha3DqInDeltaPnIndex,weight);
					SerialCC1pTrueDeltaAlpha3DMu_InDeltaPnPlot->Fill(TrueSerialDeltaAlpha3DMuInDeltaPnIndex,weight);									
					...
					SerialCC1pTrueECal_InDeltaPtxPlot->Fill(TrueSerialECalInDeltaPtxIndex,weight);
					SerialCC1pTrueECal_InDeltaPtyPlot->Fill(TrueSerialECalInDeltaPtyIndex,weight);					
					...
					int TrueSerialECalInDeltaPtxDeltaPtyIndex = tools.ReturnIndexIn3DList(TwoDArrayNBinsECalInDeltaPtxDeltaPtySlices,TrueDeltaPtxTwoDIndex,TrueDeltaPtyTwoDIndex,true_ECal);					
					...
					SerialCC1pTrueECal_InDeltaPtxDeltaPtyPlot->Fill(TrueSerialECalInDeltaPtxDeltaPtyIndex,weight);					
					...
					CC1pTrueDeltaPn_InDeltaAlpha3DqTwoDPlot[TrueDeltaAlpha3DqTwoDIndex]->Fill(true_Pn,weight);
					CC1pTrueDeltaPn_InDeltaAlpha3DMuTwoDPlot[TrueDeltaAlpha3DMuTwoDIndex]->Fill(true_Pn,weight);											
					CC1pTrueProtonMomentum_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(True_CandidateP_P->at(0),weight);										
					...
					CC1pTrueDeltaAlpha3Dq_InDeltaPnTwoDPlot[TrueDeltaPnTwoDIndex]->Fill(true_DeltaAlpha3Dq,weight);
					CC1pTrueDeltaAlpha3DMu_InDeltaPnTwoDPlot[TrueDeltaPnTwoDIndex]->Fill(true_DeltaAlpha3DMu,weight);											
					CC1pTrueDeltaAlphaT_InMuonCosThetaTwoDPlot[TrueMuonCosThetaTwoDIndex]->Fill(true_DeltaAlphaT,weight);
					CC1pTrueDeltaAlphaT_InMuonMomentumTwoDPlot[TrueMuonMomentumTwoDIndex]->Fill(true_DeltaAlphaT,weight);					
					CC1pTrueDeltaAlphaT_InProtonCosThetaTwoDPlot[TrueProtonCosThetaTwoDIndex]->Fill(true_DeltaAlphaT,weight);
					CC1pTrueDeltaAlphaT_InProtonMomentumTwoDPlot[TrueProtonMomentumTwoDIndex]->Fill(true_DeltaAlphaT,weight);																				
					...
					CC1pTrueECal_InDeltaPtxTwoDPlot[DeltaPtxTwoDIndex]->Fill(true_ECal,weight);
					CC1pTrueECal_InDeltaPtyTwoDPlot[DeltaPtyTwoDIndex]->Fill(true_ECal,weight);									
					...
					CC1pTrueECal_InDeltaPtxDeltaPtyTwoDPlot[DeltaPtxTwoDIndex][DeltaPtyTwoDIndex]->Fill(true_ECal,weight);					
...
//					CC1pRecodProtonTracksScorePlot->Fill(ProtonTrackScore,weight);
					...
					CC1pRecoDeltaAlpha3DMuPlot->Fill(DeltaAlpha3DMu,weight);										
					...
					CC1pRecoECal_InDeltaPtxDeltaPtyTwoDPlot[DeltaPtxTwoDIndex][DeltaPtyTwoDIndex]->Fill(ECal,weight);					
					...
					CC1pRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3Dq,weight);
					CC1pRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3DMu,weight);											
					CC1pRecoDeltaPT_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(TransMissMomentum,weight);
					CC1pRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[DeltaAlpha3DqTwoDIndex]->Fill(reco_Pn,weight);
					CC1pRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[DeltaAlpha3DMuTwoDIndex]->Fill(reco_Pn,weight);									
					CC1pRecoProtonMomentum_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(reco_Pp,weight);					
					...
					CC1pRecoECal_InDeltaPtxTwoDPlot[DeltaPtxTwoDIndex]->Fill(ECal,weight);
					CC1pRecoECal_InDeltaPtyTwoDPlot[DeltaPtyTwoDIndex]->Fill(ECal,weight);
					CC1pRecoDeltaAlphaT_InMuonCosThetaTwoDPlot[MuonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
					CC1pRecoDeltaAlphaT_InMuonMomentumTwoDPlot[MuonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);					
					CC1pRecoDeltaAlphaT_InProtonCosThetaTwoDPlot[ProtonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
					CC1pRecoDeltaAlphaT_InProtonMomentumTwoDPlot[ProtonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);									
					...
					SerialCC1pRecoDeltaAlphaT_InMuonMomentumPlot->Fill(SerialDeltaAlphaTInMuonMomentumIndex,weight);					
					SerialCC1pRecoDeltaAlphaT_InProtonCosThetaPlot->Fill(SerialDeltaAlphaTInProtonCosThetaIndex,weight);
					SerialCC1pRecoDeltaAlphaT_InProtonMomentumPlot->Fill(SerialDeltaAlphaTInProtonMomentumIndex,weight);					
					SerialCC1pRecoDeltaAlphaT_InDeltaPTPlot->Fill(SerialDeltaAlphaTInDeltaPTIndex,weight);
					SerialCC1pRecoDeltaAlpha3Dq_InDeltaPnPlot->Fill(SerialDeltaAlpha3DqInDeltaPnIndex,weight);
					SerialCC1pRecoDeltaAlpha3DMu_InDeltaPnPlot->Fill(SerialDeltaAlpha3DMuInDeltaPnIndex,weight);									
					SerialCC1pRecoDeltaPT_InDeltaAlphaTPlot->Fill(SerialDeltaPTInDeltaAlphaTIndex,weight);
					SerialCC1pRecoDeltaPn_InDeltaAlpha3DqPlot->Fill(SerialDeltaPnInDeltaAlpha3DqIndex,weight);
					SerialCC1pRecoDeltaPn_InDeltaAlpha3DMuPlot->Fill(SerialDeltaPnInDeltaAlpha3DMuIndex,weight);										
					SerialCC1pRecoProtonMomentum_InDeltaAlphaTPlot->Fill(SerialProtonMomentumInDeltaAlphaTIndex,weight);					
					...
					SerialCC1pRecoECal_InDeltaPtxPlot->Fill(SerialECalInDeltaPtxIndex,weight);
					SerialCC1pRecoECal_InDeltaPtyPlot->Fill(SerialECalInDeltaPtyIndex,weight);																												
					...
					SerialCC1pRecoECal_InDeltaPtxDeltaPtyPlot->Fill(SerialECalInDeltaPtxDeltaPtyIndex,weight);					
					...
					SerialCC1pRecoDeltaAlphaT_InMuonMomentumPlot2D->Fill(TrueSerialDeltaAlphaTInMuonMomentumIndex,SerialDeltaAlphaTInMuonMomentumIndex);					
					...
					SerialCC1pRecoDeltaAlphaT_InProtonMomentumPlot2D->Fill(TrueSerialDeltaAlphaTInProtonMomentumIndex,SerialDeltaAlphaTInProtonMomentumIndex);
					SerialCC1pRecoDeltaAlphaT_InDeltaPTPlot2D->Fill(TrueSerialDeltaAlphaTInDeltaPTIndex,SerialDeltaAlphaTInDeltaPTIndex);
					SerialCC1pRecoDeltaAlpha3Dq_InDeltaPnPlot2D->Fill(TrueSerialDeltaAlpha3DqInDeltaPnIndex,SerialDeltaAlpha3DqInDeltaPnIndex);
					SerialCC1pRecoDeltaAlpha3DMu_InDeltaPnPlot2D->Fill(TrueSerialDeltaAlpha3DMuInDeltaPnIndex,SerialDeltaAlpha3DMuInDeltaPnIndex);										
					SerialCC1pRecoDeltaPT_InDeltaAlphaTPlot2D->Fill(TrueSerialDeltaPTInDeltaAlphaTIndex,SerialDeltaPTInDeltaAlphaTIndex);
					SerialCC1pRecoDeltaPn_InDeltaAlpha3DqPlot2D->Fill(TrueSerialDeltaPnInDeltaAlpha3DqIndex,SerialDeltaPnInDeltaAlpha3DqIndex);
					SerialCC1pRecoDeltaPn_InDeltaAlpha3DMuPlot2D->Fill(TrueSerialDeltaPnInDeltaAlpha3DMuIndex,SerialDeltaPnInDeltaAlpha3DMuIndex);							
					SerialCC1pRecoProtonMomentum_InDeltaAlphaTPlot2D->Fill(TrueSerialProtonMomentumInDeltaAlphaTIndex, SerialProtonMomentumInDeltaAlphaTIndex);					
					SerialCC1pRecoDeltaPn_InDeltaAlphaTPlot2D->Fill(TrueSerialDeltaPnInDeltaAlphaTIndex,SerialDeltaPnInDeltaAlphaTIndex);						
					...
					SerialPOTScaledCC1pRecoDeltaAlphaT_InMuonMomentumPlot2D->Fill(TrueSerialDeltaAlphaTInMuonMomentumIndex,SerialDeltaAlphaTInMuonMomentumIndex,weight);					
					...
					SerialPOTScaledCC1pRecoDeltaAlphaT_InProtonMomentumPlot2D->Fill(TrueSerialDeltaAlphaTInProtonMomentumIndex,SerialDeltaAlphaTInProtonMomentumIndex,weight);					
					...
					SerialPOTScaledCC1pRecoDeltaAlpha3Dq_InDeltaPnPlot2D->Fill(TrueSerialDeltaAlpha3DqInDeltaPnIndex,SerialDeltaAlpha3DqInDeltaPnIndex,weight);
					SerialPOTScaledCC1pRecoDeltaAlpha3DMu_InDeltaPnPlot2D->Fill(TrueSerialDeltaAlpha3DMuInDeltaPnIndex,SerialDeltaAlpha3DMuInDeltaPnIndex,weight);										
					...
					SerialPOTScaledCC1pRecoDeltaPn_InDeltaAlpha3DqPlot2D->Fill(TrueSerialDeltaPnInDeltaAlpha3DqIndex,SerialDeltaPnInDeltaAlpha3DqIndex,weight);
					SerialPOTScaledCC1pRecoDeltaPn_InDeltaAlpha3DMuPlot2D->Fill(TrueSerialDeltaPnInDeltaAlpha3DMuIndex,SerialDeltaPnInDeltaAlpha3DMuIndex,weight);									
					SerialPOTScaledCC1pRecoProtonMomentum_InDeltaAlphaTPlot2D->Fill(TrueSerialProtonMomentumInDeltaAlphaTIndex,SerialProtonMomentumInDeltaAlphaTIndex,weight);
					SerialPOTScaledCC1pRecoDeltaPn_InDeltaAlphaTPlot2D->Fill(TrueSerialDeltaPnInDeltaAlphaTIndex,SerialDeltaPnInDeltaAlphaTIndex,weight);					
					...
					SerialCC1pRecoECal_InDeltaPtxDeltaPtyPlot2D->Fill(TrueSerialECalInDeltaPtxDeltaPtyIndex,SerialECalInDeltaPtxDeltaPtyIndex);					
					...
					SerialPOTScaledCC1pRecoECal_InDeltaPtxDeltaPtyPlot2D->Fill(TrueSerialECalInDeltaPtxDeltaPtyIndex,SerialECalInDeltaPtxDeltaPtyIndex,weight);
					...
					CC1pRecoVertexXPlot2D->Fill(True_Vx,Vertex_X->at(0));
					CC1pRecoVertexYPlot2D->Fill(True_Vy,Vertex_Y->at(0));
					CC1pRecoVertexZPlot2D->Fill(True_Vz,Vertex_Z->at(0));															
					...
					CC1pRecoDeltaAlpha3DMuPlot2D->Fill(true_DeltaAlpha3DMu,DeltaAlpha3DMu);									
					...
					POTScaledCC1pRecoVertexXPlot2D->Fill(True_Vx,Vertex_X->at(0),weight);
					POTScaledCC1pRecoVertexYPlot2D->Fill(True_Vy,Vertex_Y->at(0),weight);
					POTScaledCC1pRecoVertexZPlot2D->Fill(True_Vz,Vertex_Z->at(0),weight);					
					...
					POTScaledCC1pRecoDeltaAlpha3DMuPlot2D->Fill(true_DeltaAlpha3DMu,DeltaAlpha3DMu,weight);										
					...
					CC1pRecoECal_InDeltaPtxDeltaPtyTwoDPlot2D[DeltaPtxTwoDIndex][DeltaPtyTwoDIndex]->Fill(true_ECal,ECal);
					POTScaledCC1pRecoECal_InDeltaPtxDeltaPtyTwoDPlot2D[DeltaPtxTwoDIndex][DeltaPtyTwoDIndex]->Fill(true_ECal,ECal,weight);									
					...
					CC1pRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot2D[DeltaPnTwoDIndex]->Fill(true_DeltaAlpha3Dq,DeltaAlpha3Dq);
					POTScaledCC1pRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot2D[DeltaPnTwoDIndex]->Fill(true_DeltaAlpha3Dq,DeltaAlpha3Dq,weight);

					CC1pRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot2D[DeltaPnTwoDIndex]->Fill(true_DeltaAlpha3DMu,DeltaAlpha3DMu);
					POTScaledCC1pRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot2D[DeltaPnTwoDIndex]->Fill(true_DeltaAlpha3DMu,DeltaAlpha3DMu,weight);											
					...
					CC1pRecoDeltaPn_InDeltaAlpha3DqTwoDPlot2D[DeltaAlpha3DqTwoDIndex]->Fill(true_Pn,reco_Pn);
					POTScaledCC1pRecoDeltaPn_InDeltaAlpha3DqTwoDPlot2D[DeltaAlpha3DqTwoDIndex]->Fill(true_Pn,reco_Pn,weight);

					CC1pRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot2D[DeltaAlpha3DMuTwoDIndex]->Fill(true_Pn,reco_Pn);
					POTScaledCC1pRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot2D[DeltaAlpha3DMuTwoDIndex]->Fill(true_Pn,reco_Pn,weight);										

					CC1pRecoProtonMomentum_InDeltaAlphaTTwoDPlot2D[DeltaAlphaTTwoDIndex]->Fill(True_CandidateP_P->at(0), reco_Pp);
					POTScaledCC1pRecoProtonMomentum_InDeltaAlphaTTwoDPlot2D[DeltaAlphaTTwoDIndex]->Fill(True_CandidateP_P->at(0), reco_Pp,weight);																					
					...
					CC1pRecoECal_InDeltaPtxTwoDPlot2D[DeltaPtxTwoDIndex]->Fill(true_ECal,ECal);
					POTScaledCC1pRecoECal_InDeltaPtxTwoDPlot2D[DeltaPtxTwoDIndex]->Fill(true_ECal,ECal,weight);

					CC1pRecoECal_InDeltaPtyTwoDPlot2D[DeltaPtyTwoDIndex]->Fill(true_ECal,ECal);
					POTScaledCC1pRecoECal_InDeltaPtyTwoDPlot2D[DeltaPtyTwoDIndex]->Fill(true_ECal,ECal,weight);
					...
					CC1pRecoDeltaAlphaT_InMuonMomentumTwoDPlot2D[MuonMomentumTwoDIndex]->Fill(true_DeltaAlphaT,DeltaAlphaT);
					POTScaledCC1pRecoDeltaAlphaT_InMuonMomentumTwoDPlot2D[MuonMomentumTwoDIndex]->Fill(true_DeltaAlphaT,DeltaAlphaT,weight);					
					...
					CC1pRecoDeltaAlphaT_InProtonMomentumTwoDPlot2D[ProtonMomentumTwoDIndex]->Fill(true_DeltaAlphaT,DeltaAlphaT);
					POTScaledCC1pRecoDeltaAlphaT_InProtonMomentumTwoDPlot2D[ProtonMomentumTwoDIndex]->Fill(true_DeltaAlphaT,DeltaAlphaT,weight);																
...
//					NonCC1pRecodProtonTracksScorePlot->Fill(ProtonTrackScore,weight);
					...
					NonCC1pRecoDeltaAlpha3DMuPlot->Fill(DeltaAlpha3DMu,weight);										
					...
					NonCC1pRecoECal_InDeltaPtxDeltaPtyTwoDPlot[DeltaPtxTwoDIndex][DeltaPtyTwoDIndex]->Fill(ECal,weight);					
					...
					NonCC1pRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3Dq,weight);
					NonCC1pRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3DMu,weight);											
					NonCC1pRecoDeltaPT_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(TransMissMomentum,weight);
					NonCC1pRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[DeltaAlpha3DqTwoDIndex]->Fill(reco_Pn,weight);
					NonCC1pRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[DeltaAlpha3DMuTwoDIndex]->Fill(reco_Pn,weight);											
					NonCC1pRecoProtonMomentum_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(reco_Pp,weight);					
					...
					NonCC1pRecoECal_InDeltaPtxTwoDPlot[DeltaPtxTwoDIndex]->Fill(ECal,weight);
					NonCC1pRecoECal_InDeltaPtyTwoDPlot[DeltaPtyTwoDIndex]->Fill(ECal,weight);
					NonCC1pRecoDeltaAlphaT_InMuonCosThetaTwoDPlot[MuonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
					NonCC1pRecoDeltaAlphaT_InMuonMomentumTwoDPlot[MuonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);						
					NonCC1pRecoDeltaAlphaT_InProtonCosThetaTwoDPlot[ProtonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
					NonCC1pRecoDeltaAlphaT_InProtonMomentumTwoDPlot[ProtonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);										
					...
					SerialNonCC1pRecoDeltaAlphaT_InMuonMomentumPlot->Fill(SerialDeltaAlphaTInMuonMomentumIndex,weight);					
					SerialNonCC1pRecoDeltaAlphaT_InProtonCosThetaPlot->Fill(SerialDeltaAlphaTInProtonCosThetaIndex,weight);
					SerialNonCC1pRecoDeltaAlphaT_InProtonMomentumPlot->Fill(SerialDeltaAlphaTInProtonMomentumIndex,weight);					
					SerialNonCC1pRecoDeltaAlphaT_InDeltaPTPlot->Fill(SerialDeltaAlphaTInDeltaPTIndex,weight);
					SerialNonCC1pRecoDeltaAlpha3Dq_InDeltaPnPlot->Fill(SerialDeltaAlpha3DqInDeltaPnIndex,weight);
					SerialNonCC1pRecoDeltaAlpha3DMu_InDeltaPnPlot->Fill(SerialDeltaAlpha3DMuInDeltaPnIndex,weight);										
					SerialNonCC1pRecoDeltaPT_InDeltaAlphaTPlot->Fill(SerialDeltaPTInDeltaAlphaTIndex,weight);
					SerialNonCC1pRecoDeltaPn_InDeltaAlpha3DqPlot->Fill(SerialDeltaPnInDeltaAlpha3DqIndex,weight);
					SerialNonCC1pRecoDeltaPn_InDeltaAlpha3DMuPlot->Fill(SerialDeltaPnInDeltaAlpha3DMuIndex,weight);											
					SerialNonCC1pRecoProtonMomentum_InDeltaAlphaTPlot->Fill(SerialProtonMomentumInDeltaAlphaTIndex,weight);					
					...
					SerialNonCC1pRecoECal_InDeltaPtxPlot->Fill(SerialECalInDeltaPtxIndex,weight);
					SerialNonCC1pRecoECal_InDeltaPtyPlot->Fill(SerialECalInDeltaPtyIndex,weight);																											
					...
					SerialNonCC1pRecoECal_InDeltaPtxDeltaPtyPlot->Fill(SerialECalInDeltaPtxDeltaPtyIndex,weight);					
...
//					CCQERecodProtonTracksScorePlot->Fill(ProtonTrackScore,weight);
					...
					CCQERecoDeltaAlpha3DMuPlot->Fill(DeltaAlpha3DMu,weight);										
					...
					CCQERecoECal_InDeltaPtxDeltaPtyTwoDPlot[DeltaPtxTwoDIndex][DeltaPtyTwoDIndex]->Fill(ECal,weight);					
					...
					CCQERecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3Dq,weight);
					CCQERecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3DMu,weight);											
					CCQERecoDeltaPT_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(TransMissMomentum,weight);
					CCQERecoDeltaPn_InDeltaAlpha3DqTwoDPlot[DeltaAlpha3DqTwoDIndex]->Fill(reco_Pn,weight);
					CCQERecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[DeltaAlpha3DMuTwoDIndex]->Fill(reco_Pn,weight);										
					CCQERecoProtonMomentum_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(reco_Pp,weight);					
					...
					CCQERecoECal_InDeltaPtxTwoDPlot[DeltaPtxTwoDIndex]->Fill(ECal,weight);
					CCQERecoECal_InDeltaPtyTwoDPlot[DeltaPtyTwoDIndex]->Fill(ECal,weight);																				
					CCQERecoDeltaAlphaT_InMuonCosThetaTwoDPlot[MuonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
					CCQERecoDeltaAlphaT_InMuonMomentumTwoDPlot[MuonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);					
					CCQERecoDeltaAlphaT_InProtonCosThetaTwoDPlot[ProtonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
					CCQERecoDeltaAlphaT_InProtonMomentumTwoDPlot[ProtonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);																							
					...
					SerialCCQERecoDeltaAlphaT_InMuonMomentumPlot->Fill(SerialDeltaAlphaTInMuonMomentumIndex,weight);					
					SerialCCQERecoDeltaAlphaT_InProtonCosThetaPlot->Fill(SerialDeltaAlphaTInProtonCosThetaIndex,weight);
					SerialCCQERecoDeltaAlphaT_InProtonMomentumPlot->Fill(SerialDeltaAlphaTInProtonMomentumIndex,weight);				
					SerialCCQERecoDeltaAlphaT_InDeltaPTPlot->Fill(SerialDeltaAlphaTInDeltaPTIndex,weight);
					SerialCCQERecoDeltaAlpha3Dq_InDeltaPnPlot->Fill(SerialDeltaAlpha3DqInDeltaPnIndex,weight);
					SerialCCQERecoDeltaAlpha3DMu_InDeltaPnPlot->Fill(SerialDeltaAlpha3DMuInDeltaPnIndex,weight);										
					SerialCCQERecoDeltaPT_InDeltaAlphaTPlot->Fill(SerialDeltaPTInDeltaAlphaTIndex,weight);
					SerialCCQERecoDeltaPn_InDeltaAlpha3DqPlot->Fill(SerialDeltaPnInDeltaAlpha3DqIndex,weight);
					SerialCCQERecoDeltaPn_InDeltaAlpha3DMuPlot->Fill(SerialDeltaPnInDeltaAlpha3DMuIndex,weight);									
					SerialCCQERecoProtonMomentum_InDeltaAlphaTPlot->Fill(SerialProtonMomentumInDeltaAlphaTIndex,weight);					
					...
					SerialCCQERecoECal_InDeltaPtxPlot->Fill(SerialECalInDeltaPtxIndex,weight);
					SerialCCQERecoECal_InDeltaPtyPlot->Fill(SerialECalInDeltaPtyIndex,weight);																												
					...
					SerialCCQERecoECal_InDeltaPtxDeltaPtyPlot->Fill(SerialECalInDeltaPtxDeltaPtyIndex,weight);					
...
//					CCMECRecodProtonTracksScorePlot->Fill(ProtonTrackScore,weight);
					...
					CCMECRecoDeltaAlpha3DMuPlot->Fill(DeltaAlpha3DMu,weight);									
					...
					CCMECRecoECal_InDeltaPtxDeltaPtyTwoDPlot[DeltaPtxTwoDIndex][DeltaPtyTwoDIndex]->Fill(ECal,weight);					
					...
					CCMECRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3Dq,weight);
					CCMECRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3DMu,weight);											
					CCMECRecoDeltaPT_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(TransMissMomentum,weight);
					CCMECRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[DeltaAlpha3DqTwoDIndex]->Fill(reco_Pn,weight);
					CCMECRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[DeltaAlpha3DMuTwoDIndex]->Fill(reco_Pn,weight);											
					CCMECRecoProtonMomentum_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(reco_Pp,weight);					
					...
					CCMECRecoECal_InDeltaPtxTwoDPlot[DeltaPtxTwoDIndex]->Fill(ECal,weight);
					CCMECRecoECal_InDeltaPtyTwoDPlot[DeltaPtyTwoDIndex]->Fill(ECal,weight);																											
					CCMECRecoDeltaAlphaT_InMuonCosThetaTwoDPlot[MuonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
					CCMECRecoDeltaAlphaT_InMuonMomentumTwoDPlot[MuonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);					
					CCMECRecoDeltaAlphaT_InProtonCosThetaTwoDPlot[ProtonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
					CCMECRecoDeltaAlphaT_InProtonMomentumTwoDPlot[ProtonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);										
					...
					SerialCCMECRecoDeltaAlphaT_InMuonMomentumPlot->Fill(SerialDeltaAlphaTInMuonMomentumIndex,weight);					
					SerialCCMECRecoDeltaAlphaT_InProtonCosThetaPlot->Fill(SerialDeltaAlphaTInProtonCosThetaIndex,weight);
					SerialCCMECRecoDeltaAlphaT_InProtonMomentumPlot->Fill(SerialDeltaAlphaTInProtonMomentumIndex,weight);					
					SerialCCMECRecoDeltaAlphaT_InDeltaPTPlot->Fill(SerialDeltaAlphaTInDeltaPTIndex,weight);
					SerialCCMECRecoDeltaAlpha3Dq_InDeltaPnPlot->Fill(SerialDeltaAlpha3DqInDeltaPnIndex,weight);
					SerialCCMECRecoDeltaAlpha3DMu_InDeltaPnPlot->Fill(SerialDeltaAlpha3DMuInDeltaPnIndex,weight);										
					SerialCCMECRecoDeltaPT_InDeltaAlphaTPlot->Fill(SerialDeltaPTInDeltaAlphaTIndex,weight);
					SerialCCMECRecoDeltaPn_InDeltaAlpha3DqPlot->Fill(SerialDeltaPnInDeltaAlpha3DqIndex,weight);
					SerialCCMECRecoDeltaPn_InDeltaAlpha3DMuPlot->Fill(SerialDeltaPnInDeltaAlpha3DMuIndex,weight);											
					SerialCCMECRecoProtonMomentum_InDeltaAlphaTPlot->Fill(SerialProtonMomentumInDeltaAlphaTIndex,weight);					
					...
					SerialCCMECRecoECal_InDeltaPtxPlot->Fill(SerialECalInDeltaPtxIndex,weight);
					SerialCCMECRecoECal_InDeltaPtyPlot->Fill(SerialECalInDeltaPtyIndex,weight);																												
					...
					SerialCCMECRecoECal_InDeltaPtxDeltaPtyPlot->Fill(SerialECalInDeltaPtxDeltaPtyIndex,weight);					
...
//					CCRESRecodProtonTracksScorePlot->Fill(ProtonTrackScore,weight);
					...
					CCRESRecoDeltaAlpha3DMuPlot->Fill(DeltaAlpha3DMu,weight);										
					...
					CCRESRecoECal_InDeltaPtxDeltaPtyTwoDPlot[DeltaPtxTwoDIndex][DeltaPtyTwoDIndex]->Fill(ECal,weight);					
					...
					CCRESRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3Dq,weight);
					CCRESRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3DMu,weight);												
					CCRESRecoDeltaPT_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(TransMissMomentum,weight);
					CCRESRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[DeltaAlpha3DqTwoDIndex]->Fill(reco_Pn,weight);
					CCRESRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[DeltaAlpha3DMuTwoDIndex]->Fill(reco_Pn,weight);										
					CCRESRecoProtonMomentum_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(reco_Pp,weight);					
					...
					CCRESRecoECal_InDeltaPtxTwoDPlot[DeltaPtxTwoDIndex]->Fill(ECal,weight);
					CCRESRecoECal_InDeltaPtyTwoDPlot[DeltaPtyTwoDIndex]->Fill(ECal,weight);																						
					CCRESRecoDeltaAlphaT_InMuonCosThetaTwoDPlot[MuonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
					CCRESRecoDeltaAlphaT_InMuonMomentumTwoDPlot[MuonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);					
					CCRESRecoDeltaAlphaT_InProtonCosThetaTwoDPlot[ProtonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
					CCRESRecoDeltaAlphaT_InProtonMomentumTwoDPlot[ProtonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);										
					...
					SerialCCRESRecoDeltaAlphaT_InMuonMomentumPlot->Fill(SerialDeltaAlphaTInMuonMomentumIndex,weight);					
					SerialCCRESRecoDeltaAlphaT_InProtonCosThetaPlot->Fill(SerialDeltaAlphaTInProtonCosThetaIndex,weight);
					SerialCCRESRecoDeltaAlphaT_InProtonMomentumPlot->Fill(SerialDeltaAlphaTInProtonMomentumIndex,weight);					
					SerialCCRESRecoDeltaAlphaT_InDeltaPTPlot->Fill(SerialDeltaAlphaTInDeltaPTIndex,weight);
					SerialCCRESRecoDeltaAlpha3Dq_InDeltaPnPlot->Fill(SerialDeltaAlpha3DqInDeltaPnIndex,weight);
					SerialCCRESRecoDeltaAlpha3DMu_InDeltaPnPlot->Fill(SerialDeltaAlpha3DMuInDeltaPnIndex,weight);										
					SerialCCRESRecoDeltaPT_InDeltaAlphaTPlot->Fill(SerialDeltaPTInDeltaAlphaTIndex,weight);
					SerialCCRESRecoDeltaPn_InDeltaAlpha3DqPlot->Fill(SerialDeltaPnInDeltaAlpha3DqIndex,weight);
					SerialCCRESRecoDeltaPn_InDeltaAlpha3DMuPlot->Fill(SerialDeltaPnInDeltaAlpha3DMuIndex,weight);											
					SerialCCRESRecoProtonMomentum_InDeltaAlphaTPlot->Fill(SerialProtonMomentumInDeltaAlphaTIndex,weight);					
					...
					SerialCCRESRecoECal_InDeltaPtxPlot->Fill(SerialECalInDeltaPtxIndex,weight);
					SerialCCRESRecoECal_InDeltaPtyPlot->Fill(SerialECalInDeltaPtyIndex,weight);																												
					...
					SerialCCRESRecoECal_InDeltaPtxDeltaPtyPlot->Fill(SerialECalInDeltaPtxDeltaPtyIndex,weight);					
...
//					CCDISRecodProtonTracksScorePlot->Fill(ProtonTrackScore,weight);
					...
					CCDISRecoDeltaAlpha3DMuPlot->Fill(DeltaAlpha3DMu,weight);									
					...
					CCDISRecoECal_InDeltaPtxDeltaPtyTwoDPlot[DeltaPtxTwoDIndex][DeltaPtyTwoDIndex]->Fill(ECal,weight);					
					...
					CCDISRecoDeltaAlpha3Dq_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3Dq,weight);
					CCDISRecoDeltaAlpha3DMu_InDeltaPnTwoDPlot[DeltaPnTwoDIndex]->Fill(DeltaAlpha3DMu,weight);											
					CCDISRecoDeltaPT_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(TransMissMomentum,weight);
					CCDISRecoDeltaPn_InDeltaAlpha3DqTwoDPlot[DeltaAlpha3DqTwoDIndex]->Fill(reco_Pn,weight);
					CCDISRecoDeltaPn_InDeltaAlpha3DMuTwoDPlot[DeltaAlpha3DMuTwoDIndex]->Fill(reco_Pn,weight);											
					CCDISRecoProtonMomentum_InDeltaAlphaTTwoDPlot[DeltaAlphaTTwoDIndex]->Fill(reco_Pp,weight);					
					...
					CCDISRecoECal_InDeltaPtxTwoDPlot[DeltaPtxTwoDIndex]->Fill(ECal,weight);
					CCDISRecoECal_InDeltaPtyTwoDPlot[DeltaPtyTwoDIndex]->Fill(ECal,weight);																					
					CCDISRecoDeltaAlphaT_InMuonCosThetaTwoDPlot[MuonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
					CCDISRecoDeltaAlphaT_InMuonMomentumTwoDPlot[MuonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);						
					CCDISRecoDeltaAlphaT_InProtonCosThetaTwoDPlot[ProtonCosThetaTwoDIndex]->Fill(DeltaAlphaT,weight);
					CCDISRecoDeltaAlphaT_InProtonMomentumTwoDPlot[ProtonMomentumTwoDIndex]->Fill(DeltaAlphaT,weight);														
					...
					SerialCCDISRecoDeltaAlphaT_InMuonMomentumPlot->Fill(SerialDeltaAlphaTInMuonMomentumIndex,weight);					
					SerialCCDISRecoDeltaAlphaT_InProtonCosThetaPlot->Fill(SerialDeltaAlphaTInProtonCosThetaIndex,weight);
					SerialCCDISRecoDeltaAlphaT_InProtonMomentumPlot->Fill(SerialDeltaAlphaTInProtonMomentumIndex,weight);					
					SerialCCDISRecoDeltaAlphaT_InDeltaPTPlot->Fill(SerialDeltaAlphaTInDeltaPTIndex,weight);
					SerialCCDISRecoDeltaAlpha3Dq_InDeltaPnPlot->Fill(SerialDeltaAlpha3DqInDeltaPnIndex,weight);
					SerialCCDISRecoDeltaAlpha3DMu_InDeltaPnPlot->Fill(SerialDeltaAlpha3DMuInDeltaPnIndex,weight);										
					SerialCCDISRecoDeltaPT_InDeltaAlphaTPlot->Fill(SerialDeltaPTInDeltaAlphaTIndex,weight);
					SerialCCDISRecoDeltaPn_InDeltaAlpha3DqPlot->Fill(SerialDeltaPnInDeltaAlpha3DqIndex,weight);
					SerialCCDISRecoDeltaPn_InDeltaAlpha3DMuPlot->Fill(SerialDeltaPnInDeltaAlpha3DMuIndex,weight);										
					SerialCCDISRecoProtonMomentum_InDeltaAlphaTPlot->Fill(SerialProtonMomentumInDeltaAlphaTIndex,weight);					
					...
					SerialCCDISRecoECal_InDeltaPtxPlot->Fill(SerialECalInDeltaPtxIndex,weight);
					SerialCCDISRecoECal_InDeltaPtyPlot->Fill(SerialECalInDeltaPtyIndex,weight);																											
					...
					SerialCCDISRecoECal_InDeltaPtxDeltaPtyPlot->Fill(SerialECalInDeltaPtxDeltaPtyIndex,weight);					
