...
void PeLEE_PrintLatexTables(TString BaseMC = "", bool PrintEventLoss = false, bool PrintStats = false, bool PrintPurEff = false, bool PrintCosmicCont = false, bool PrintIntBreakDown = false, bool PrintMCBkg = false) {
	...
	PlotNames.push_back("SamdefEventPlot"); PlotLabels.push_back("PeLEE CC Inclusive");
...
//	PlotNames.push_back("NuScoreEventPlot"); PlotLabels.push_back("$\\nu$ score");
	PlotNames.push_back("CommonEventPlot"); PlotLabels.push_back("Common ranges");
...
//		} // If we want to run only on a specific cut combination, include this } and remove the one at the end of the program
			...
			TH1D* hTruthContainedCC1pOverlay = (TH1D*)(TruthCC1pFile->Get("TrueContainedEndMuonCosThetaPlot"));
