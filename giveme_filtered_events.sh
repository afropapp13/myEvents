...
runsubrunlist=run1_run_subrun_list_data.txt

# The name of the sam def which you made the run subrun event list from
originalsamdef=numi_uboone_run1_beamon_offset1_mcc9_reco2_v08_00_00_28_beam_good_snapshot

# choose a name for your sam def, any name as long as it doesnt already exist
newsamdef=run1_data_filter_9aug2020
